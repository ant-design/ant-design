...
- Table
  ...
  - 🐞 Fix Table `@table-border-radius-base` not being applied to `.ofs-table` node. [#29966](https://github.com/ant-design/ant-design/pull/29966) [@VoliBearCat](https://github.com/VoliBearCat)
