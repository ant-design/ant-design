...
- Collapse
  ...
  - 🐞 Fix the problem that the content of Panel will disappear when the `activeKey` is set when Collapse is hidden. [#30555](https://github.com/ant-design/ant-design/pull/30555) [@zjffun](https://github.com/zjffun)
