...
- Table
  - 🐞 Fix Table selection state not syncing when selected rows are removed from dataSource. [#56975](https://github.com/ant-design/ant-design/pull/56975) [@kiannidev](https://github.com/kiannidev)
- Upload
