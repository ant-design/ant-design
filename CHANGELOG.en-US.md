...
- 🐞 Fix Table header cell border when have <code class="notranslate">rowSpan</code> and <code class="notranslate">scroll.y</code>. [#35591](https://github.com/ant-design/ant-design/pull/35591)
