...
- 🐞 Fix the Table `cellFontSizeSM` and `cellFontSizeLG` tokens were not working. [#55770](https://github.com/ant-design/ant-design/pull/55770) [@guoyunhe](https://github.com/guoyunhe)
