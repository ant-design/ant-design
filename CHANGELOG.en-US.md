...
- 🆕 add showCollapsibleIcon API to splitter component. [#54154](https://github.com/ant-design/ant-design/pull/54154) [@rxy001](https://github.com/rxy001)
...
- 🆕 `Tooltip` support configure text color by `props.color` [#54552](https://github.com/ant-design/ant-design/pull/54552) [@EmilyyyLiu](https://github.com/EmilyyyLiu)
...
- 💄 Fix hover/active text color of button with `variant="filled"` and  `href` set. [#54614](https://github.com/ant-design/ant-design/pull/54614) [@Komoszek](https://github.com/Komoszek)
