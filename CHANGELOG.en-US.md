...
- 🆕 Flex `gap` prop support number. [#55591](https://github.com/ant-design/ant-design/pull/55591) [@ayangweb](https://github.com/ayangweb)
- 🐞 Fix Popconfirm to reset ref when error occurs in `actionFn`. [#55519](https://github.com/ant-design/ant-design/pull/55519) [@Taoister39](https://github.com/Taoister39)
- Carousel
...
- 🐞 Fix Descriptions that content style wrongly used `labelStyle`. [#55572](https://github.com/ant-design/ant-design/pull/55572) [@li-jia-nan](https://github.com/li-jia-nan)
