...
- 🆕 Transfer `operations` prop now supports ReactNode array for custom operation buttons. [@YOUR_GITHUB_USERNAME](https://github.com/YOUR_GITHUB_USERNAME)
...
- Input
  - 🐞 Fix Input with `allowClear` not correctly selecting next element when Tab key is pressed. [#52977](https://github.com/ant-design/ant-design/pull/52977) [@wanpan11](https://github.com/wanpan11)
  - 💄 Fix Input with `variant="underlined"` border display issue on hover when disabled. [#52959](https://github.com/ant-design/ant-design/pull/52959) [@ustcfury](https://github.com/ustcfury)
- 💄 Fix DatePicker header button unexpected spacing causing misalignment. [#53007](https://github.com/ant-design/ant-design/pull/53007) [@DDDDD12138](https://github.com/DDDDD12138)
- 💄 Fix AutoComplete text not vertically centered when `size="large"`. [#52819](https://github.com/ant-design/ant-design/pull/52819) [@aojunhao123](https://github.com/aojunhao123)
- 🇩🇪 Improve `de_DE` Transfer localization. [#53047](https://github.com/ant-design/ant-design/pull/53047) [@chrisinick](https://github.com/chrisinick)
