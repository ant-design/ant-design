...
6. 运行`npm run test -- -u` 来更新 snapshot，在这之前或许你还需要先删除 `node_modules` 和 `yarn.lock` or `package-lock.json` 并全新安装
7. 更新 `docs/react/i18n.zh-CN.md` and `docs/react/i18n.zh-CN.md`, 将对应语音添加到文档列表
8. 万事俱备等待 review
