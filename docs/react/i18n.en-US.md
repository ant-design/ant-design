...
2. Add the language support for [@rc-component/picker](https://github.com/react-component/picker), for example [this](https://github.com/react-component/picker/blob/master/src/locale/en_US.ts).
...
4. Wait for `@rc-component/picker` and `@rc-component/pagination` to release the new version containing the above.
5. Update the `@rc-component/picker` and `@rc-component/pagination` versions in `antd` and add the remaining other necessary content for the language. for example [Azerbaijani PR](https://github.com/ant-design/ant-design/pull/21387).
