...
| **Trae** | Add to MCP settings. [Documentation](https://trae.ai/docs) | `Add Ant Design MCP server. Configuration: { "mcpServers": { "antd-components": { "command": "npx", "args": ["-y", "@jzone-mcp/antd-components-mcp"] } } }` |
