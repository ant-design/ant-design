...
### ⚛️ Ant Design 各版本对 React 的支持矩阵

| React 版本 | v1.x      | v2.x      | v3.x        | v4.x        | v5.x        | v6.x      |
| ---------- | --------- | --------- | ----------- | ----------- | ----------- | --------- |
| React 0.14 | 🟢 支持   | 🟢 支持   | 🔴 不支持   | 🔴 不支持   | 🔴 不支持   | 🔴 不支持 |
| React 15   | 🟢 支持   | 🟢 支持   | 🟢 支持     | 🔴 不支持   | 🔴 不支持   | 🔴 不支持 |
| React 16   | 🔴 不支持 | 🟢 支持   | 🟢 支持     | 🟢 支持     | 🔴 不支持   | 🔴 不支持 |
| React 17   | 🔴 不支持 | 🔴 不支持 | ⚪ 部分支持 | 🟢 支持     | 🟢 支持     | 🔴 不支持 |
| React 18   | 🔴 不支持 | 🔴 不支持 | 🔴 不支持   | ⚪ 部分支持 | 🟢 支持     | 🟢 支持   |
| React 19   | 🔴 不支持 | 🔴 不支持 | 🔴 不支持   | 🔴 不支持   | ⚪ 部分支持 | 🟢 支持   |

<p>🟢 = 支持 ⚪ = 部分支持 🔴 = 不支持</p>

| IE 版本 | v1.x | v2.x | v3.x | v4.x | v5.x | v6.x |
| --- | --- | --- | --- | --- | --- | --- |
| IE8 | 🟢 支持 | 🔴 不支持 | 🔴 不支持 | 🔴 不支持 | 🔴 不支持 | 🔴 不支持 |
| IE9 | 🟢 支持 | 🟢 支持 | 🟢 支持 | 🔴 不支持 | 🔴 不支持 | 🔴 不支持 |
| IE10 | 🟢 支持 | 🟢 支持 | 🟢 支持 | 🔴 不支持 | 🔴 不支持 | 🔴 不支持 |
| IE11 | 🟢 支持 | 🟢 支持 | 🟢 支持 | 🟢 支持 | 🔴 不支持 | 🔴 不支持 |
| Edge / Chrome / Firefox / Safari | 🟢 支持 | 🟢 支持 | 🟢 支持 | 🟢 支持 | 🟢 支持 | 🟢 支持 |
