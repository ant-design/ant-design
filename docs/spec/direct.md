...
> Note：In「Multi-Field Inline Edit」, there are huge different between the content and required field, So it is more needed to use the [「Explain What Just Happened」](/docs/spec/transition#explain-what-just-happened) in 「Use Transition」to eliminate this visual effects.
