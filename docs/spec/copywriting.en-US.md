...
Refrain from using redundant phrases or words, and do not repeat anything the user already knows. In most cases, it is unnecessary to use an interface to describe all minute details.
