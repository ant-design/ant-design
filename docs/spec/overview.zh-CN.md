...
- 组件 - 基本组件：系统的最基本元素，例如按钮和寻呼机。- 业务组件/模块：块级示例，通常由多个组件组成，例如 PageHeader 通用标题。
...
- [Ant Design Components](https://ant.design/docs/react/introduce)：Ant Design 的 React UI 库是一个拥有 50 多个基础组件的全局组件库
