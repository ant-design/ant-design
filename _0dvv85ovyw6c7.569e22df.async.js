(globalThis.utooChunk_antd||(globalThis.utooChunk_antd=[])).push(["object"==typeof document?document.currentScript:void 0,564062,e=>{"use strict";var t=e.i(191788);e.s(["f",0,(...e)=>{let[i,n]=(0,t.useState)(...e);return[i,(...e)=>{(0,t.startTransition)(()=>{n(...e)})}]}])},758035,e=>{"use strict";var t=e.i(391398),i=e.i(191788),n=e.i(218589),l=e.i(831036);let s=(0,e.i(827830).createStyles)(({css:e,cssVar:t,token:i})=>({codeSpan:e`
  ...
  `,tokenTitle:h.css`
    font-size: ${e.fontSizeLG};
    font-weight: bold;
  `})),k=e=>{let{defaultOpen:m=!0,tokens:k,title:b,helpText:w,helpLink:C,component:S,comment:$}=e,[,z]=(0,u.default)(y),M=(0,h.useTheme)(),T=(0,f.Y)(),[B,W]=(0,i.useState)(m),{styles:N}=v(),A=(0,i.useMemo)(()=>{let e=S?`<ConfigProvider
  theme={{
    components: {
      ${S}: {
        /* ${$?.componentComment} */
...
>
  ...
</ConfigProvider>`;return p.default.highlight(e,p.default.languages.jsx||p.default.languages.javascript,"jsx")},[S,$]);if(!k.length)return null;let L=k.sort(S?void 0:g).map(e=>{let t=S?x.B.components[S].find(t=>t.token===e):x.B.global[e];return t?{name:e,desc:"cn"===z?t.desc:t.descEn,type:t.type,value:S?x.A[S]?.component[e]:j[e]}:null}).filter(e=>null!=e);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)("div",{className:N.tableTitle,onClick:()=>W(e=>!e),children:[(0,t.jsx)(s.f,{className:N.arrowIcon,rotate:90*!!B}),(0,t.jsxs)(r.f,{className:N.tokenTitle,gap:"small",justify:"flex-start",align:"center",children:[b,(0,t.jsx)("span",{onClick:e=>e.stopPropagation(),children:(0,t.jsx)(o.f,{title:null,destroyOnHidden:!0,styles:{root:{width:400}},content:(0,t.jsxs)(d.f,{children:[(0,t.jsx)("pre",{dir:"ltr",style:{fontSize:12},children:(0,t.jsx)("code",{dir:"ltr",dangerouslySetInnerHTML:{__html:A}})}),(0,t.jsxs)("a",{href:C,target:"_blank",rel:"noopener noreferrer",children:[(0,t.jsx)(n.f,{style:{marginInlineEnd:4}}),w]})]}),children:(0,t.jsxs)("span",{className:N.help,children:[(0,t.jsx)(l.f,{style:{marginInlineEnd:4}}),w]})})})]})]}),B&&(0,t.jsx)(a.f,{theme:{token:{borderRadius:0}},children:(0,t.jsx)(c.f,{size:"middle",columns:T,bordered:!0,dataSource:L,style:{marginBottom:M.margin},pagination:!1,rowKey:e=>e.name})})]})};var b=i.default.memo(({component:e})=>{let[n]=(0,u.default)(y),l=(0,i.useMemo)(()=>{let{componentComment:e,globalComment:t}=n;return{componentComment:e,globalComment:t}},[n]),s=(0,i.useMemo)(()=>{let t=new Set;return e.split(",").forEach(e=>{let{global:i=[]}=x.A[e]||{};i.forEach(e=>{t.add(e)})}),Array.from(t)},[e]);return(0,t.jsxs)(t.Fragment,{children:[x.B.components[e]?.length>0&&(0,t.jsx)(k,{defaultOpen:!0,title:n.componentToken,helpText:n.help,helpLink:n.customizeTokenLink,tokens:x.B.components[e].map(e=>e.token),component:e,comment:l}),s.length>0&&(0,t.jsx)(k,{defaultOpen:!0,title:n.globalToken,helpText:n.help,helpLink:n.customizeComponentTokenLink,tokens:s,comment:l})]})});e.s(["f",0,b])},720637,e=>{"use strict";var t=e.i(391398),i=e.i(191788),n=e.i(91595),l=e.i(771229),s=e.i(707065),a=e.i(183668),r=e.i(788296),o=e.i(624057),c=e.i(797091),d=e.i(927298),h=e.i(564062),m=e.i(926602),p=e.i(741214);let u=(0,e.i(827830).createStaticStyles)(({css:e,cssVar:t})=>({skeletonWrapper:e`
    width: 100% !important;
    height: 250px;
  ...
  `}));var f=()=>(0,t.jsx)(p.f.Node,{active:!0,className:u.skeletonWrapper,style:{width:"100%",height:"100%"},children:" "});e.s(["f",0,({items:e})=>{let{showDebug:p,setShowDebug:u}=i.default.use(m.f),[x,g]=(0,h.f)(!1),j=i.default.useMemo(()=>e.reduce((e,t)=>{let{previewerProps:i}=t,{debug:n}=i;return n&&!p?e:e.concat({...t,previewerProps:{...i,expand:x,debug:!1,originDebug:n}})},[]),[x,e,p]);return(0,t.jsxs)("div",{className:"demo-wrapper",children:[(0,t.jsx)(s.B,{styles:s.m`
        ...
        `}),(0,t.jsxs)("span",{className:"all-code-box-controls",children:[(0,t.jsx)(r.f,{title:(0,t.jsx)(d.f,{id:`app.component.examples.${x?"collapse":"expand"}`}),children:(0,t.jsx)(a.f,{type:"text",size:"small",icon:(0,t.jsx)(l.f,{}),onClick:()=>{g(!x)},className:x?"icon-enabled":""})}),(0,t.jsx)(r.f,{title:(0,t.jsx)(d.f,{id:`app.component.examples.${p?"hide":"visible"}`}),children:(0,t.jsx)(a.f,{type:"text",size:"small",icon:(0,t.jsx)(n.f,{}),onClick:()=>{u?.(!p)},className:p?"icon-enabled":""})})]}),(0,t.jsx)(c.f,{items:j,demoRender:e=>(0,t.jsx)(i.Suspense,{fallback:(0,t.jsx)(f,{}),children:(0,t.jsx)(o.f,{...e})},e.demo.id)})]})}],720637)},939120,e=>{e.v(t=>Promise.all(["_1a25sveg9lx7z.a0622655.async.js","_00-_j-f8_2k3x.36ee296a.async.js","_0v-gnlk31bs36.2eb5e328.async.js","node_modules__ant-design_icons_es_index_041zy7bfa7wdx.c28b81f0.async.js"].map(t=>e.l(t))).then(()=>t(93447)))},34131,e=>{"use strict";var t=e.i(391398),i=e.i(191788),n=e.i(741214),l=e.i(827830);let s=i.default.lazy(()=>e.A(939120)),a=(0,l.createStaticStyles)(({css:e,cssVar:t})=>({searchWrapper:e`
    display: flex;
    gap: ${t.padding};
    > *:first-child {
      flex: 0 0 328px;
