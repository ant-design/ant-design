// Extract Component `styles` or `classNames` definition from source code
// Which is used in official site to generate styles meta
...
const main = async () => {
  ...
  if (project) {
    ...
    const output = '.dumi/preset/components-semantic-meta.json';
