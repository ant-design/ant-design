...
- 🛡 Написано на TypeScript із передбачуваними статичними типами.
...
| --- | --- | --- | --- | --- |
| IE11, Edge | останні 2 версії | останні 2 версії | останні 2 версії | останні 2 версії |
...
`antd` написано на TypeScript із всіма визначеннями, вибери [Використання у TypeScript](https://ant.design/docs/react/use-in-typescript) щоб розпочати.
