...
export default defineConfig({
  ...
  test: {
    ...
    exclude: [
      ...
      'components/color-picker/__tests__/disabled-component.test.tsx',
      'components/color-picker/__tests__/gradient.test.tsx',
      'components/color-picker/__tests__/index.test.tsx',
      'components/color-picker/__tests__/panel-disabled.test.tsx',
      'components/color-picker/__tests__/semantic.test.tsx',
      'components/color-picker/__tests__/stepper-disabled.test.tsx',
