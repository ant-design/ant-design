...
<div class="ant-flex css-var-test-id ant-flex-align-center ant-flex-gap-middle ant-flex-vertical" style="position: absolute; margin-bottom: 80px;">
        ...
        <div class="ant-select ant-cascader ant-select-outlined semantic-mark-root ant-select-css-var ant-cascader-css-var css-var-test-id ant-select-multiple ant-select-allow-clear ant-select-show-arrow ant-select-open" style="width: 200px;">
          ...
          <div class="ant-select-suffix semantic-mark-suffix" style="margin-inline-end: 24px;">
            <span aria-label="down" class="anticon anticon-down" role="img">
              <svg aria-hidden="true" data-icon="down" fill="currentColor" focusable="false" height="1em" viewBox="64 64 896 896" width="1em">
                <path d="M884 256h-75c-5.1 0-9.9 2.5-12.9 6.6L512 654.2 227.9 262.6c-3-4.1-7.8-6.6-12.9-6.6h-75c-6.5 0-10.3 7.4-6.5 12.7l352.6 486.1c12.8 17.6 39 17.6 51.7 0l352.6-486.1c3.9-5.3.1-12.7-6.4-12.7z"></path>
              </svg>
          ...
          <ul class="ant-dropdown-menu ant-dropdown-menu-root ant-dropdown-menu-vertical ant-dropdown-menu-light css-var-test-id ant-dropdown-css-var css-var-test-id ant-dropdown-menu-css-var" data-menu-list="true" role="menu" tabindex="0">
            <li class="ant-dropdown-menu-item-group" role="presentation">
              ...
              <ul class="ant-dropdown-menu-item-group-list" role="group">
                <li class="ant-dropdown-menu-item semantic-mark-item" data-menu-id="rc-menu-uuid-test-id-1-1" role="menuitem" tabindex="-1">
                ...
                <li class="ant-dropdown-menu-item semantic-mark-item" data-menu-id="rc-menu-uuid-test-id-1-2" role="menuitem" tabindex="-1">
            ...
            <li class="ant-dropdown-menu-submenu ant-dropdown-menu-submenu-vertical ant-dropdown-menu-submenu-open" role="none">
              <div aria-controls="rc-menu-uuid-test-id-SubMenu-popup" aria-expanded="true" aria-haspopup="true" class="ant-dropdown-menu-submenu-title" data-menu-id="rc-menu-uuid-test-id-SubMenu" role="menuitem" tabindex="-1">
            ...
            </li><li class="ant-dropdown-menu-item semantic-mark-item ant-dropdown-menu-item-danger" data-menu-id="rc-menu-uuid-test-id-4" role="menuitem" tabindex="-1">
...
Source: https://ant.design/components/layout-cn/semantic.md
...
Source: https://ant.design/components/listy-cn/semantic.md
          ...
          <div class="ant-mentions-measure">
            ...
            <div class="ant-mentions-dropdown semantic-mark-popup css-var-test-id ant-mentions-css-var ant-mentions-dropdown-placement-bottomRight" style="--arrow-x: 0px; --arrow-y: 0px; left: -1000vw; top: -1000vh; right: auto; bottom: auto; box-sizing: border-box; z-index: 1;">
              <ul class="ant-mentions-dropdown-menu ant-mentions-dropdown-menu-root ant-mentions-dropdown-menu-vertical" data-menu-list="true" role="menu" tabindex="0">
                <li class="ant-mentions-dropdown-menu-item ant-mentions-dropdown-menu-item-active" data-menu-id="rc-menu-uuid-test-id-afc163-test-id" role="menuitem" tabindex="-1">
                  afc163
                </li>
                <li class="ant-mentions-dropdown-menu-item" data-menu-id="rc-menu-uuid-test-id-zombieJ-test-id" role="menuitem" tabindex="-1">
                  zombieJ
                </li>
                <li class="ant-mentions-dropdown-menu-item" data-menu-id="rc-menu-uuid-test-id-thinkasany-test-id" role="menuitem" tabindex="-1">
                  thinkasany
                </li>
                <li class="ant-mentions-dropdown-menu-item" data-menu-id="rc-menu-uuid-test-id-meet-student-test-id" role="menuitem" tabindex="-1">
                  meet-student
                </li>
              </ul>
              <div aria-hidden="true" style="display: none;">
...
<div class="ant-flex css-var-test-id ant-flex-align-center ant-flex-gap-medium ant-flex-vertical">
        ...
        <div style="height: 360px;">
          <ul class="ant-menu ant-menu-root ant-menu-inline ant-menu-light css-var-test-id ant-menu-css-var semantic-mark-root" data-menu-list="true" role="menu" style="width: 230px;" tabindex="0">
            <li class="ant-menu-item ant-menu-item-selected semantic-mark-item" data-menu-id="rc-menu-uuid-test-id-mail" role="menuitem" style="padding-left: 24px;" tabindex="-1">
            ...
            <li class="ant-menu-submenu ant-menu-submenu-inline ant-menu-submenu-open" role="none">
              <div aria-controls="rc-menu-uuid-test-id-SubMenu-popup" aria-expanded="true" aria-haspopup="true" class="ant-menu-submenu-title" data-menu-id="rc-menu-uuid-test-id-SubMenu" role="menuitem" style="padding-left: 24px;" tabindex="-1">
              ...
              <ul class="ant-menu ant-menu-sub ant-menu-inline" data-menu-list="true" id="rc-menu-uuid-test-id-SubMenu-popup" role="menu">
                <li class="ant-menu-item-group" role="presentation">
                  ...
                  <ul class="ant-menu-item-group-list semantic-mark-subMenu-list" role="group">
                    <li class="ant-menu-item semantic-mark-subMenu-item" data-menu-id="rc-menu-uuid-test-id-1" role="menuitem" style="padding-left: 48px;" tabindex="-1">
                    ...
                    <li class="ant-menu-item semantic-mark-subMenu-item ant-menu-item-only-child" data-menu-id="rc-menu-uuid-test-id-2" role="menuitem" style="padding-left: 48px;" tabindex="-1">
                      <span class="ant-menu-title-content semantic-mark-subMenu-itemContent">
                        Option 2
                      </span>
                    </li>
            ...
            <li class="ant-menu-item-group" role="presentation">
              ...
              <ul class="ant-menu-item-group-list semantic-mark-list" role="group">
                <li class="ant-menu-item semantic-mark-item ant-menu-item-only-child" data-menu-id="rc-menu-uuid-test-id-3" role="menuitem" style="padding-left: 24px;" tabindex="-1">
                  <span class="ant-menu-title-content semantic-mark-itemContent">
                    Option 3
                  </span>
                </li>
                <li class="ant-menu-item semantic-mark-item ant-menu-item-only-child" data-menu-id="rc-menu-uuid-test-id-4" role="menuitem" style="padding-left: 24px;" tabindex="-1">
                  <span class="ant-menu-title-content semantic-mark-itemContent">
                    Option 4
                  </span>
                </li>
...
<div class="ant-notification ant-notification-list ant-notification-topRight css-var-test-id ant-notification-css-var semantic-mark-list" style="position: relative; inset: auto; width: 432px; max-width: 100%; height: auto; padding: 24px; transform: none;">
        <div class="ant-notification-list-content ant-notification-list-content-increase semantic-mark-listContent" style="height: 0px; --top-notificiation-height: 0px; --top-notificiation-width: 0px;">
          <div class="ant-notification-notice ant-notification-notice-success semantic-mark-root ant-notification-notice-closable" data-notification-index="1" role="alert" style="--notification-index: 1; --notification-y: 0px;">
            ...
            <button aria-label="Close" class="ant-notification-notice-close semantic-mark-close" type="button">
...
<div aria-label="segmented control" aria-orientation="horizontal" class="ant-segmented semantic-mark-root css-var-test-id" role="radiogroup" tabindex="0">
        <div class="ant-segmented-group">
          <label class="ant-segmented-item semantic-mark-item ant-segmented-item-selected ant-segmented-item-selected-text">
            <input checked="" class="ant-segmented-item-input" name="test-id" type="radio">
...
<div class="ant-flex css-var-test-id ant-flex-align-stretch ant-flex-gap-large ant-flex-vertical" style="width: 100%;">
        ...
        <div class="ant-steps ant-steps-horizontal ant-steps-title-horizontal ant-steps-filled ant-steps-panel ant-steps-small css-var-test-id" style="--ant-cmp-steps-items-offset: 0; width: 100%;">
          <div class="ant-steps-item ant-steps-item-finish semantic-mark-root">
            ...
            <svg aria-hidden="true" class="ant-steps-panel-arrow" preserveAspectRatio="none" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
...
<div class="ant-flex css-var-test-id ant-flex-align-center ant-flex-gap-middle ant-flex-vertical" style="position: absolute; margin-bottom: 80px;">
        ...
        <div class="ant-select ant-tree-select ant-select-outlined semantic-mark-root css-var-test-id ant-select-css-var ant-tree-select-css-var ant-select-multiple ant-select-allow-clear ant-select-show-arrow ant-select-open ant-select-show-search" style="width: 300px;">
          ...
          <button aria-label="Clear" class="ant-select-clear" type="button">
            <span aria-label="close-circle" class="anticon anticon-close-circle" role="img">
              <svg aria-hidden="true" data-icon="close-circle" fill="currentColor" fill-rule="evenodd" focusable="false" height="1em" viewBox="64 64 896 896" width="1em">
                <path d="M512 64c247.4 0 448 200.6 448 448S759.4 960 512 960 64 759.4 64 512 264.6 64 512 64zm127.98 274.82h-.04l-.08.06L512 466.75 384.14 338.88c-.04-.05-.06-.06-.08-.06a.12.12 0 00-.07 0c-.03 0-.05.01-.09.05l-45.02 45.02a.2.2 0 00-.05.09.12.12 0 000 .07v.02a.27.27 0 00.06.06L466.75 512 338.88 639.86c-.05.04-.06.06-.06.08a.12.12 0 000 .07c0 .03.01.05.05.09l45.02 45.02a.2.2 0 00.09.05.12.12 0 00.07 0c.02 0 .04-.01.08-.05L512 557.25l127.86 127.87c.04.04.06.05.08.05a.12.12 0 00.07 0c.03 0 .05-.01.09-.05l45.02-45.02a.2.2 0 00.05-.09.12.12 0 000-.07v-.02a.27.27 0 00-.05-.06L557.25 512l127.87-127.86c.04-.04.05-.06.05-.08a.12.12 0 000-.07c0-.03-.01-.05-.05-.09l-45.02-45.02a.2.2 0 00-.09-.05.12.12 0 00-.07 0z"></path>
              </svg>
          ...
          <div class="ant-upload-list-item-container">
            <div class="ant-upload-list-item ant-upload-list-item-uploading semantic-mark-item">
              ...
              <span class="ant-upload-list-item-actions">
                <button aria-label="Remove file" class="ant-btn css-var-test-id ant-btn-text ant-btn-color-default ant-btn-variant-text ant-btn-sm ant-btn-icon-only ant-upload-list-item-action" title="Remove file" type="button">
                  <span class="ant-btn-icon">
