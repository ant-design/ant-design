...
components:
  ...
  badge:
    ...
    status-size: '6px'
  breadcrumb:
    item-color: '{colors.text-tertiary}'
    last-item-color: '{colors.text}'
    icon-font-size: '14px'
    link-color: '{colors.text-tertiary}'
    link-hover-color: '{colors.text}'
  ...
  button:
    ...
    text-text-hover-color: '{colors.text}'
    text-text-active-color: '{colors.text}'
    text-hover-bg: '{colors.fill-tertiary}'
    default-color: '{colors.text}'
    default-bg: '{colors.bg-container}'
    default-border-color: '{colors.border}'
    default-border-color-disabled: '{colors.border}'
    ...
    content-font-size-sm: '14px'
    content-font-size-lg: '16px'
    content-line-height: '1.5714285714285714'
    content-line-height-sm: '1.5714285714285714'
    content-line-height-lg: '1.5'
    padding-block: '4px'
    padding-block-sm: '0px'
    padding-block-lg: '7px'
    default-bg-disabled: '{colors.fill-tertiary}'
    dashed-bg-disabled: '{colors.fill-tertiary}'
  card:
    ...
    extra-color: '{colors.text}'
    body-padding-sm: '12px'
    header-padding-sm: '12px'
    body-padding: '24px'
    header-padding: '24px'
  checkbox: {}
  collapse:
  ...
  date-picker:
    ...
    cell-hover-bg: '{colors.fill-tertiary}'
    cell-active-with-range-bg: '{colors.primary-bg}'
    cell-hover-with-range-bg: '#cbe0fd'
    cell-range-border-color: '#82b4f9'
    cell-bg-disabled: '{colors.fill-tertiary}'
    ...
    multiple-item-height: '24px'
    multiple-item-height-sm: '16px'
    multiple-item-height-lg: '32px'
    multiple-selector-bg-disabled: '{colors.fill-tertiary}'
    multiple-item-color-disabled: '{colors.text-quaternary}'
  ...
  dropdown:
    ...
    arrow-offset-vertical: '8px'
    arrow-shadow-width: '8.970562748477143px'
  form:
    label-required-mark-color: '{colors.error}'
    label-color: '{colors.text}'
    label-font-size: '14px'
    label-height: '32px'
    label-colon-margin-inline-start: '2px'
    label-colon-margin-inline-end: '8px'
    item-margin-bottom: '24px'
    vertical-label-padding: '0 0 8px'
    vertical-label-margin: '0px'
    inline-item-margin-bottom: '0px'
  input:
    padding-block: '4px'
    padding-block-sm: '0px'
    padding-block-lg: '7px'
  ...
  menu:
    ...
    radius-sub-menu-item: '4px'
    sub-menu-item-border-radius: '4px'
    color-item-text: '{colors.text}'
    item-color: '{colors.text}'
    color-item-text-hover: '{colors.text}'
    item-hover-color: '{colors.text}'
    color-item-text-hover-horizontal: '{colors.primary}'
    horizontal-item-hover-color: '{colors.primary}'
    color-group-title: '{colors.text-tertiary}'
    group-title-color: '{colors.text-tertiary}'
    color-item-text-selected: '{colors.primary}'
    item-selected-color: '{colors.primary}'
    sub-menu-item-selected-color: '{colors.primary}'
    color-item-text-selected-horizontal: '{colors.primary}'
    horizontal-item-selected-color: '{colors.primary}'
    ...
    item-active-bg: '{colors.primary-bg}'
    color-sub-item-bg: '{colors.fill-quaternary}'
    sub-menu-item-bg: '{colors.fill-quaternary}'
    color-item-bg-selected: '{colors.primary-bg}'
    item-selected-bg: '{colors.primary-bg}'
    color-item-bg-selected-horizontal: 'transparent'
    horizontal-item-selected-bg: 'transparent'
    color-active-bar-width: '0px'
    active-bar-width: '0px'
    color-active-bar-height: '2px'
    active-bar-height: '2px'
    color-active-bar-border-size: '1px'
    active-bar-border-width: '1px'
    color-item-text-disabled: '{colors.text-quaternary}'
    item-disabled-color: '{colors.text-quaternary}'
    color-danger-item-text: '{colors.error}'
    danger-item-color: '{colors.error}'
    color-danger-item-text-hover: '{colors.error}'
    danger-item-hover-color: '{colors.error}'
    color-danger-item-text-selected: '{colors.error}'
    danger-item-selected-color: '{colors.error}'
  ...
  modal:
    ...
    confirm-icon-margin-inline-end: '16px'
    confirm-btns-margin-top: '24px'
    mask: 'true'
  notification:
    width: '384px'
  ...
  pagination:
    ...
    item-active-color-disabled: '{colors.text-quaternary}'
  ...
  radio:
    radio-size: '16px'
    dot-size: '8px'
    dot-color-disabled: '{colors.text-quaternary}'
    button-solid-checked-color: '{colors.text-light-solid}'
    button-solid-checked-bg: '{colors.primary}'
    ...
    button-checked-color-disabled: '{colors.text-quaternary}'
    button-padding-inline: '15px'
    wrapper-margin-inline-end: '8px'
    radio-color: '{colors.primary}'
    radio-bg-color: '{colors.bg-container}'
  select:
    option-selected-color: '{colors.text}'
    option-selected-font-weight: '600'
    option-selected-bg: '{colors.primary-bg}'
    option-active-bg: '{colors.fill-tertiary}'
    ...
    select-affix-padding: '4px'
  slider:
    control-size: '10px'
    rail-size: '4px'
    handle-size: '10px'
    handle-size-hover: '12px'
    dot-size: '8px'
    handle-line-width: '2px'
    handle-line-width-hover: '2.5px'
    rail-bg: '{colors.fill-tertiary}'
    rail-hover-bg: '{colors.fill-secondary}'
    track-bg: '{colors.primary-border}'
    track-hover-bg: '{colors.primary-border-hover}'
    handle-color: '{colors.primary-border}'
    handle-active-color: '{colors.primary}'
    handle-active-outline-color: 'rgba(22,119,255,0.2)'
    handle-color-disabled: '#bfbfbf'
    dot-border-color: '{colors.border-secondary}'
    dot-active-border-color: '{colors.primary-border}'
    track-bg-disabled: '{colors.fill-tertiary}'
  steps:
    ...
    nav-arrow-color: '{colors.text-quaternary}'
    nav-content-max-width: 'unset'
    wait-icon-color: '{colors.text-quaternary}'
    wait-icon-bg-color: '{colors.bg-container}'
    wait-icon-border-color: '{colors.text-quaternary}'
    finish-icon-bg-color: '{colors.bg-container}'
    finish-icon-border-color: '{colors.primary}'
  switch:
    track-height: '22px'
  ...
  table:
    ...
    body-sort-bg: '#fafafa'
    row-hover-bg: '#fafafa'
    row-selected-bg: '{colors.primary-bg}'
    row-selected-hover-bg: '{colors.primary-bg-hover}'
    row-expanded-bg: '{colors.fill-quaternary}'
    cell-padding-block: '16px'
    cell-padding-inline: '16px'
    cell-padding-block-md: '12px'
    cell-padding-inline-md: '8px'
    cell-padding-block-sm: '8px'
    cell-padding-inline-sm: '8px'
    border-color: '{colors.border-secondary}'
    header-border-radius: '8px'
    footer-bg: '#fafafa'
    footer-color: '{colors.text}'
    cell-font-size: '14px'
    cell-font-size-md: '14px'
    cell-font-size-sm: '14px'
    ...
    sticky-scroll-bar-bg: '{colors.text-quaternary}'
  ...
  tabs:
    ...
    title-font-size-lg: '16px'
    title-font-size-sm: '14px'
    ink-bar-color: '{colors.primary}'
...
5. Respect the rounded scale; do not introduce arbitrary border-radius values outside the 6-step system.
