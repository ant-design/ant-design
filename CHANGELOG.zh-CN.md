...
- 🐞 修复组件 Spin 可能出现跳动的 问题。[#8602](https://github.com/ant-design/ant-design/issues/8602) [@jhsu](https://github.com/jhsu)
...
- 🌟 支持 List 组件自定义加载动画。 [#8702](https://github.com/ant-design/ant-design/pull/8702) [@nikogu](https://github.com/nikogu)
