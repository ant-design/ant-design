...
在 9 月我们带了 `3.9.0` 的更新。 `3.9.0` 中带了多项新特性，Ant Design 的能力得到了极大地提升，越来越接近世界第一组件库。
...
- 🔥 Drawer 的 `placement` 支持 `top` 和 `bottom`，来适应更多场景。
...
- 🌟 Anchor 组件增加 `onClik` 属性。[#11898](https://github.com/ant-design/ant-design/pull/11898)
