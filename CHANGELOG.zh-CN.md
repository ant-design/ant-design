...
- Table
  - 🆕 Table 行选择下拉菜单支持 `getPopupContainer`。[#22787](https://github.com/ant-design/ant-design/pull/22787) [@mikeyshing88](https://github.com/mikeyshing88)
  ...
  - 🐞 修复当 `column` 的 children 为 `undefined` 时整列未显示的问题。[#22832](https://github.com/ant-design/ant-design/pull/22832)
  - 🐞 修复 Table 在 `filters` 为 `undefined` 时仍然展示过滤按钮的问题。[#22833](https://github.com/ant-design/ant-design/pull/22833)
  - 🐞 修复 Table `filters` 未变化时触发 `onChange` 事件的问题。[ddb0a](https://github.com/ant-design/ant-design/commit/ddb0ac46ba7b5ccc04f496523938d87484489191)
...
- 🛠 重构 Picker 拆分成多文件。[#22850](https://github.com/ant-design/ant-design/pull/22850)
...
- 💄 优化 `@info-color` less 变量，默认为 `@primary-color`。[3f8db](https://github.com/ant-design/ant-design/commit/3f8dbc500fd31b631a10bbacceaee07bf61df02a)
...
- 🐞 修复 Tabs 不支持小尺寸。[#22666](https://github.com/ant-design/ant-design/pull/22666) [@MrHeer](https://github.com/MrHeer)
...
- 🐞 移除 Tabs 的 tabpane 轮廓线。[#22752](https://github.com/ant-design/ant-design/pull/22752) [@MrHeer](https://github.com/MrHeer)
...
- RTL
  - 🐞 优化 Menu RTL 样式问题。[#22841](https://github.com/ant-design/ant-design/pull/22841)
  - 🐞 修复 Form RTL 下 label 显示。[#22621](https://github.com/ant-design/ant-design/pull/22621)
  - 🐞 修复 Space RTL 样式。[#22809](https://github.com/ant-design/ant-design/pull/22809)
- TypeScript
