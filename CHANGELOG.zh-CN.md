...
- 🐞 修复 Popconfirm `actionFn` 出错后无异常响应的问题。[#55519](https://github.com/ant-design/ant-design/pull/55519) [@Taoister39](https://github.com/Taoister39)
- Carousel
...
- 🐞 修复 Description 组建内容样式错误使用 `labelStyle` 的问题。[#55572](https://github.com/ant-design/ant-design/pull/55572) [@li-jia-nan](https://github.com/li-jia-nan)
