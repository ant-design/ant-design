...
- 🔥 新增组件 Space.Compact。[#37652](https://github.com/ant-design/ant-design/pull/37652) [@foryuki](https://github.com/foryuki)
- 🆕 Form 下组件支持自定义 disabled 覆盖 Form 的 disabled 状态。[#37628](https://github.com/ant-design/ant-design/pull/37628) [@kiner-tang](https://github.com/kiner-tang)
...
- 🆕 Tabs 组件支持从 ConfigProvider 取出 `getPopupContainer` 传入 rc-tabs。[#38238](https://github.com/ant-design/ant-design/pull/38238) [@ZH-seven](https://github.com/ZH-seven)
...
- Dropdown
  - 🆕 Dropdown 支持 items 属性。[#37885](https://github.com/ant-design/ant-design/pull/37885) [@JarvisArt](https://github.com/JarvisArt)
...
- Transfer
  ...
  - 🛠 移除 Transfer defaultprops。[#38164](https://github.com/ant-design/ant-design/pull/38164) [#38154](https://github.com/ant-design/ant-design/pull/38154) [@li-jia-nan](https://github.com/li-jia-nan)
- 🛠 重构 Anchor 为 Function Component。[#38265](https://github.com/ant-design/ant-design/pull/38265) [#37957](https://github.com/ant-design/ant-design/pull/37957) [@li-jia-nan](https://github.com/li-jia-nan) [@RexSkz](https://github.com/RexSkz)
- 🛠 简化 DirectoryTree ref 逻辑。[#38184](https://github.com/ant-design/ant-design/pull/38184) [@holazz](https://github.com/holazz)
- 🛠 简化 Typography.Link ref 逻辑。[#38181](https://github.com/ant-design/ant-design/pull/38181) [@holazz](https://github.com/holazz)
- 🛠 使用枚举代替常量值，表达内部 Ellipsis 的计算状态。[#37716](https://github.com/ant-design/ant-design/pull/37716) [@zheeeng](https://github.com/zheeeng)
- 💄 修复 TextArea 开启 `allowClear` 时自定义 border 样式无法生效的问题。[#38101](https://github.com/ant-design/ant-design/pull/38101)
- 💄 修复 Popconfirm 设置 `icon={null}` 的时 `title` padding 仍然存在的问题 。现在 icon 元素外会包裹一个 span 标签。[#37384](https://github.com/ant-design/ant-design/pull/37384) [@edc-hui](https://github.com/edc-hui)
- 💄 修复 submenu::after 在紧凑模式下的伪元素宽度。[#38223](https://github.com/ant-design/ant-design/pull/38223) [@messaooudi](https://github.com/messaooudi)
- Carousel
