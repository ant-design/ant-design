...
- 🆕 实现 `onChangeComplete` API。[#43370](https://github.com/ant-design/ant-design/pull/43370) [@RedJue](https://github.com/RedJue)
...
- 💄 ConfigProvider 支持 DatePicker 和 TimePicker 组件的 className 和 style 属性。[#43418](https://github.com/ant-design/ant-design/pull/43418) [@Yuiai01](https://github.com/Yuiai01)
...
- 💄 ConfigProvider 支持 Carousel 组件的 className 和 style 属性。[#43412](https://github.com/ant-design/ant-design/pull/43412) [@Yuiai01](https://github.com/Yuiai01)
- 💄 ConfigProvider 支持 Statistic 组件的 className 和 style 属性。[#43408](https://github.com/ant-design/ant-design/pull/43408) [@Yuiai01](https://github.com/Yuiai01)
...
- 💄 ConfigProvider 支持 Drawer 组件的 className 和 style 属性。[#43396](https://github.com/ant-design/ant-design/pull/43396) [@Yuiai01](https://github.com/Yuiai01)
- 💄 ConfigProvider 支持 Timeline 组件的 className 和 style 属性。[#43392](https://github.com/ant-design/ant-design/pull/43392) [@Yuiai01](https://github.com/Yuiai01)
- 💄 ConfigProvider 支持 Collapse 组件的 className 和 style 属性。[#43390](https://github.com/ant-design/ant-design/pull/43390) [@Yuiai01](https://github.com/Yuiai01)
- 💄 ConfigProvider 支持 List 组件的 className 和 style 属性。[#43387](https://github.com/ant-design/ant-design/pull/43387) [@Yuiai01](https://github.com/Yuiai01)
- 💄 ConfigProvider 支持 Calendar 组件的 className 和 style 属性。[#43385](https://github.com/ant-design/ant-design/pull/43385) [@Yuiai01](https://github.com/Yuiai01)
- 💄 ConfigProvider 支持 Transfer 组件的 className 和 style 属性。[#43063](https://github.com/ant-design/ant-design/pull/43063) [@Yuiai01](https://github.com/Yuiai01)
- 💄 ConfigProvider 支持 Alert 组件的 className 和 style 属性。[#43384](https://github.com/ant-design/ant-design/pull/43384) [@Yuiai01](https://github.com/Yuiai01)
...
- 💄 ConfigProvider 支持 Skeleton 组件的 className 和 style 属性。[#43382](https://github.com/ant-design/ant-design/pull/43382) [@Yuiai01](https://github.com/Yuiai01)
- 💄 ConfigProvider 支持 Progress 组件的 className 和 style 属性。[#43340](https://github.com/ant-design/ant-design/pull/43340) [@Yuiai01](https://github.com/Yuiai01)
- 💄 ConfigProvider 支持 Skeleton 组件的 className 和 style 属性。[#43062](https://github.com/ant-design/ant-design/pull/43062) [@Yuiai01](https://github.com/Yuiai01)
...
- 💄 -。[#43339](https://github.com/ant-design/ant-design/pull/43339) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 `ConfigProvider` 支持 `Tree` 组件的 className 和 style 属性。[#43060](https://github.com/ant-design/ant-design/pull/43060) [@Yuiai01](https://github.com/Yuiai01)
- 💄 -。[#43333](https://github.com/ant-design/ant-design/pull/43333) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 -。[#43328](https://github.com/ant-design/ant-design/pull/43328) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 -。[#43325](https://github.com/ant-design/ant-design/pull/43325) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 -。[#43319](https://github.com/ant-design/ant-design/pull/43319) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 -。[#43315](https://github.com/ant-design/ant-design/pull/43315) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 -。[#43308](https://github.com/ant-design/ant-design/pull/43308) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 -。[#43301](https://github.com/ant-design/ant-design/pull/43301) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 -。[#43294](https://github.com/ant-design/ant-design/pull/43294) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 -。[#43283](https://github.com/ant-design/ant-design/pull/43283) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 -。[#43270](https://github.com/ant-design/ant-design/pull/43270) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 feat: CP 支持 Badge 组件的 className 和 style 属性。[#43197](https://github.com/ant-design/ant-design/pull/43197) [@li-jia-nan](https://github.com/li-jia-nan)
- 🆕 颜色选择器实现 `panelRender` API。[#43134](https://github.com/ant-design/ant-design/pull/43134) [@RedJue](https://github.com/RedJue)
- 💄 feat: Badge 支持 classNames 属性和 styles 属性。[#43245](https://github.com/ant-design/ant-design/pull/43245) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 ConfigProvider 支持 `Form` 组件的 className 和 style 属性。[#43230](https://github.com/ant-design/ant-design/pull/43230) [@MuxinFeng](https://github.com/MuxinFeng)
- 💄 ConfigProvider 支持 `Layout` 组件的 className 和 style 属性。[#43241](https://github.com/ant-design/ant-design/pull/43241) [@MuxinFeng](https://github.com/MuxinFeng)
- 💄 ConfigProvider 支持 `Input` 组件的 className 和 style 属性。[#43227](https://github.com/ant-design/ant-design/pull/43227) [@MuxinFeng](https://github.com/MuxinFeng)
- 💄 ConfigProvider 支持 `Modal` 组件的 className 和 style 属性。[#43219](https://github.com/ant-design/ant-design/pull/43219) [@MuxinFeng](https://github.com/MuxinFeng)
- 💄 ConfigProvider 支持 `Cascader` 组件的 className 和 style 属性。[#43205](https://github.com/ant-design/ant-design/pull/43205) [@MuxinFeng](https://github.com/MuxinFeng)
- 💄 ConfigProvider 支持 `Select` 组件的 className 和 style 属性。[#43217](https://github.com/ant-design/ant-design/pull/43217) [@MuxinFeng](https://github.com/MuxinFeng)
- 💄 ConfigProvider 支持`Mentions` 组件的 className 和 style 属性。[#43192](https://github.com/ant-design/ant-design/pull/43192) [@MuxinFeng](https://github.com/MuxinFeng)
- 💄 `ConfigProvider` 支持 `Radio` 组件的 className 和 style 属性。[#43067](https://github.com/ant-design/ant-design/pull/43067) [@MuxinFeng](https://github.com/MuxinFeng)
- 💄 `ConfigProvider` 支持 `Empty` 组件的 className 和 style 属性。[#43061](https://github.com/ant-design/ant-design/pull/43061) [@MuxinFeng](https://github.com/MuxinFeng)
- 💄 ConfigProvider 支持 `Anchor` 组件的 className 和 style 属性。[#43189](https://github.com/ant-design/ant-design/pull/43189) [@MuxinFeng](https://github.com/MuxinFeng)
- 💄 --。[#43100](https://github.com/ant-design/ant-design/pull/43100) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 `ConfigProvider` 支持 `Descriptions` 组件的 className 和 style 属性。[#43106](https://github.com/ant-design/ant-design/pull/43106) [@MuxinFeng](https://github.com/MuxinFeng)
- 💄 `ConfigProvider` 支持 `Checkbox` 组件的 className 和 style 属性。[#43107](https://github.com/ant-design/ant-design/pull/43107) [@MuxinFeng](https://github.com/MuxinFeng)
...
- 💄 -。[#43095](https://github.com/ant-design/ant-design/pull/43095) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 -。[#43092](https://github.com/ant-design/ant-design/pull/43092) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 -。[#43080](https://github.com/ant-design/ant-design/pull/43080) [@li-jia-nan](https://github.com/li-jia-nan)
- 💄 -。[#43074](https://github.com/ant-design/ant-design/pull/43074) [@li-jia-nan](https://github.com/li-jia-nan)
- 🚫 解决 Alert 组件循环引用。[#42801](https://github.com/ant-design/ant-design/pull/42801) [@jrr997](https://github.com/jrr997)
- 🛠 解决 Checkbox 循环引用。[#42803](https://github.com/ant-design/ant-design/pull/42803) [@jrr997](https://github.com/jrr997)
- 🛠 Table 循环引用。[#42813](https://github.com/ant-design/ant-design/pull/42813) [@jrr997](https://github.com/jrr997)
- 🛠 Description 循环依赖。[#42812](https://github.com/ant-design/ant-design/pull/42812) [@jrr997](https://github.com/jrr997)
- 💄 CP 支持 Steps 的 className 和 style 属性。[#43073](https://github.com/ant-design/ant-design/pull/43073) [@li-jia-nan](https://github.com/li-jia-nan)
- 🐞 修复 TextArea 组件在屏幕大小变化时设置的高度失效的问题。[#43169](https://github.com/ant-design/ant-design/pull/43169) [@MadCcc](https://github.com/MadCcc)
- 🛠 解决 DatePicker 循环引用。[#42809](https://github.com/ant-design/ant-design/pull/42809) [@jrr997](https://github.com/jrr997)
- 🛠 解决 useSize 循环引用。[#42810](https://github.com/ant-design/ant-design/pull/42810) [@jrr997](https://github.com/jrr997)
...
- 🆕 颜色选择器实现 `size` API。[#43116](https://github.com/ant-design/ant-design/pull/43116) [@RedJue](https://github.com/RedJue)
...
- 💄 CP 支持 Typography 的 className 和 style 属性。[#43070](https://github.com/ant-design/ant-design/pull/43070) [@li-jia-nan](https://github.com/li-jia-nan)
- 🆕 标签组件支持通过设置 closeIcon 为 null 或 false 隐藏关闭按钮。[#43109](https://github.com/ant-design/ant-design/pull/43109) [@kiner-tang](https://github.com/kiner-tang)
- 🆕 标签页组件支持通过设置 closeIcon 为 null 或 false 隐藏关闭按钮。[#43098](https://github.com/ant-design/ant-design/pull/43098) [@kiner-tang](https://github.com/kiner-tang)
- 💄 `ConfigProvider` 支持 `Divider` 组件的 className 和 style 属性。[#43042](https://github.com/ant-design/ant-design/pull/43042) [@MuxinFeng](https://github.com/MuxinFeng)
- 🆕 `颜色选择器` 实现 `showText ` API。[#42865](https://github.com/ant-design/ant-design/pull/42865) [@RedJue](https://github.com/RedJue)
- 🆕 为 ColorPicker 添加 destroyTooltipOnHide。[#42645](https://github.com/ant-design/ant-design/pull/42645) [@linxianxi](https://github.com/linxianxi)
...
- 💄 修改 组件 less token。[#42428](https://github.com/ant-design/ant-design/pull/42428) [@heiyu4585](https://github.com/heiyu4585)
- 🆕 抽屉组件支持通过设置 closeIcon 为 null 或 false 隐藏关闭按钮。[#42993](https://github.com/ant-design/ant-design/pull/42993) [@kiner-tang](https://github.com/kiner-tang)
...
- 🆕 - 警告组件支持通过设置 closeIcon 为 null 或 false 隐藏关闭按钮 <br>- 废弃 closeText 属性。[#42962](https://github.com/ant-design/ant-design/pull/42962) [@kiner-tang](https://github.com/kiner-tang)
- 🆕 通知组件支持通过设置 closeIcon 为 null 或 false 隐藏关闭按钮。[#42927](https://github.com/ant-design/ant-design/pull/42927) [@kiner-tang](https://github.com/kiner-tang)
- 🛠 解决 color-picker 组件循环依赖问题。[#42843](https://github.com/ant-design/ant-design/pull/42843) [@MuxinFeng](https://github.com/MuxinFeng)
- 🛠 解决主题组件循环依赖问题。[#42852](https://github.com/ant-design/ant-design/pull/42852) [@kiner-tang](https://github.com/kiner-tang)
- RTL
