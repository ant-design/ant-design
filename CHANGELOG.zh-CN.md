...
- 🐞 修复 Input.Search 的 `enterButton` 属性误导性描述，以阐明其行为以及与其他属性的交互。[#52614](https://github.com/ant-design/ant-design/pull/52614) [@Muhammad-Taif-Khan](https://github.com/Muhammad-Taif-Khan)
