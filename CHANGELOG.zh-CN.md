...
- 🐞 修复 Upload 组件点击某文件的下载按钮后，鼠标移出该文件，仍展示下载按钮的问题。[#44594](https://github.com/ant-design/ant-design/pull/44594) [@zbw-zbw](https://github.com/zbw-zbw)
...
- 迁移 less 变量到 Token
  ...
  - 将 Tree 组件的 less 变量迁移到组件 Token。[#44282](https://github.com/ant-design/ant-design/pull/44282)
  - 将 Cascader 组件的 less 变量迁移到组件 Token。[#44261](https://github.com/ant-design/ant-design/pull/44261)
  - 将 Layout 组件的 less 变量迁移到 Design Token。[#44174](https://github.com/ant-design/ant-design/pull/44174)
  - 将 Table 组件的 less 变量迁移到 Design Token。[#44118](https://github.com/ant-design/ant-design/pull/44118)
  - Watermark 现在可以在嵌套的 Modal 和 Drawer 组件中生效。[#44104](https://github.com/ant-design/ant-design/pull/44104)
  - 将 Button 组件的 less 变量迁移到组件 Token。[#44090](https://github.com/ant-design/ant-design/pull/44090)
  - 将 Switch 组件的 less 变量迁移到 Token。[#42192](https://github.com/ant-design/ant-design/pull/42192) [@Yuiai01](https://github.com/Yuiai01)
  - 将 Select 组件的 less 变量迁移到组件 Token。[#44228](https://github.com/ant-design/ant-design/pull/44228)
  ...
  - 将 Spin 组件的 less 变量迁移到组件 Token。[#44334](https://github.com/ant-design/ant-design/pull/44334)
  - 将 Input 组件的 less 变量迁移到组件 Token。[#44325](https://github.com/ant-design/ant-design/pull/44325)
