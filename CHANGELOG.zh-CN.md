...
- 🌟 Empty 支持通过 `Empty.PRESENTED_IMAGE_DEFAULT` 和 `Empty.PRESENTED_IMAGE_SIMPLE` 访问内部图片。[#15487](https://github.com/ant-design/ant-design/pull/15487)
...
- 🐞 回滚 Tag 换行样式。[#15690](https://github.com/ant-design/ant-design/pull/15690)
