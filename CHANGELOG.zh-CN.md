...
- 🐞 解决了删除连续相同数字时的光标位置问题。[#21344](https://github.com/ant-design/ant-design/pull/21344)
- 💄 移除掉多余的背景色。[#21365](https://github.com/ant-design/ant-design/pull/21365)
...
- 🐞 修复屏幕小于 xs 时标签宽度不正确的问题。[#21222](https://github.com/ant-design/ant-design/pull/21222)
...
- 💄 修正 suffix，Firefox 中的样式，TextArea allowClear 中的输入边框半径的样式问题。[#21316](https://github.com/ant-design/ant-design/pull/21316)
- 🐞 Pagination 自定义 `itemRender` 返回的上一页下一页现在会补充 `disabled` 属性。[#21361](https://github.com/ant-design/ant-design/pull/21361)
- 🌎 添加了阿塞拜疆语翻译。[#21387](https://github.com/ant-design/ant-design/pull/21387)
- Typescript
  - 🔷 添加`MenuItemGroupProps`导出。 [#21356](https://github.com/ant-design/ant-design/pull/21356)
