...
- 🐞 修复 Typography 组件 `type` 属性使用错误颜色变量的问题。[#53086](https://github.com/ant-design/ant-design/pull/53086) [@zombieJ](https://github.com/zombieJ)
- 🐞 修复 Affix 组件在 React 18 以下版本中 `onChange` 事件异常。[#53038](https://github.com/ant-design/ant-design/pull/53038) [@waiter](https://github.com/waiter)
- 🐞 修复 Form 组件 `requiredMark` 在禁用状态下不生效的问题。[#52950](https://github.com/ant-design/ant-design/pull/52950) [@Wxh16144](https://github.com/Wxh16144)
