...
- 🌟 更新 `rc-collapse` 到 1.9.0 来支持组件 `Collapse` 按键控制。[react-component/collapse#84](https://github.com/react-component/collapse/pull/84/)  [@kossel](https://github.com/kossel)
