...
- 🐞 修复 `Menu` 组件 `openKeys` 比 `defaultOpenKeys` 有更高的优先级。[#12361](https://github.com/ant-design/ant-design/pull/12361) [@tangjinzhou](https://github.com/tangjinzhou)
- `Upload` 组件相关
...
- 图标相关内容
  ...
  - 🐞 修复 `Icon` svg 对齐方式。[0698c](https://github.com/ant-design/ant-design/commit/0698c8217327224611d4be5fcfd149a355f1c08d)
  ...
  - 🐞 修复 `Table` 组件的排序图对齐方式。[c935d](https://github.com/ant-design/ant-design/commit/c935d53b713afb3ec314133d749ca4e29e0c1ee5)
-  TypeScript
