...
describe('DropdownButton', () => {
  ...
  it('pass appropriate props to Dropdown', () => {
    ...
    rerender(<DropdownButton items={items} open />);
  ...
  it("don't pass open to Dropdown if it's not exits", () => {
    ...
    render(<DropdownButton items={items} />);
  ...
  it('should support href like Button', () => {
    ...
    const { asFragment } = render(<DropdownButton items={items} href="https://ant.design" />);
  ...
  it('should pass mouseEnterDelay and mouseLeaveDelay to Dropdown', () => {
    ...
    render(<DropdownButton mouseEnterDelay={1} mouseLeaveDelay={2} items={items} />);
  ...
  it('should support loading', () => {
    ...
    const { container } = render(<DropdownButton items={items} loading />);
