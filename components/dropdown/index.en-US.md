...
| autoAdjustOverflow | Whether to adjust dropdown placement automatically when dropdown is off screen. Supports `adjustX`, `adjustY`, `shiftX`, and `shiftY` in object mode | boolean \| { adjustX?: boolean \| number; adjustY?: boolean \| number; shiftX?: boolean \| number; shiftY?: boolean \| number } | true | 5.2.0, object: 6.6.0 | × |
