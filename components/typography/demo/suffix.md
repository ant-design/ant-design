...
class Demo extends React.Component {
  ...
  render() {
    ...
    const article = `To be, or not to be, that is a question: Whether it is nobler in the mind to suffer. 
      ...
      rub! For in that sleep of death what dreams may come When we have shuffled off this 
      mortal coil, Must give us pause. There's the respect That makes calamity of so long life`;
    return (
      <div>
