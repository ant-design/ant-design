...
| copyable | 是否可拷贝，为对象时可进行各种自定义 | boolean \| { text: string, onCopy: function, icon: ReactNode, tooltips: \[ReactNode, ReactNode\] \| false } | false | `icon` 和 `tooltips` 在 `4.4.0` 支持。tooltips 在 4.5.4 支持 false |
