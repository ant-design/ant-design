...
| autoAdjustOverflow | Whether to adjust popup placement automatically when popup is off screen. Supports `adjustX`, `adjustY`, `shiftX`, and `shiftY` in object mode | boolean \| { adjustX?: boolean \| number; adjustY?: boolean \| number; shiftX?: boolean \| number; shiftY?: boolean \| number } | true | object: 6.6.0 | × |
