...
| arrow | Change arrow's visible state and change whether the arrow is pointed at the center of target，below 5.2.0 use arrowPointAtCenter prop instead | boolean \| { arrowPointAtCenter: boolean } | true | 5.2.0 |
