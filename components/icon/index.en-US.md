...
Semantic vector graphics. Before use icons, you need to install `infra-design-icons` package:
...
| scriptUrl | The URL generated by [iconfont.cn](http://iconfont.cn/) project. Support `string[]` after `infra-design-icons@4.1.0` | string \| string\[] | - |  |
