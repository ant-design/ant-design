...
| onItemSelect | Select item(The event parameter is passed to enable multiple selection while holding down the shift key) | (key: string, selected: boolean, event: React.MouseEvent<Element, MouseEvent>) |  |
