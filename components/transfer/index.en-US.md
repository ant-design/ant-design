...
| filterOption | A function to determine whether an item should show in search result list, only works when searching, (' direction 'since 5.9.0+ support) | (inputValue, option, direction: `left` \| `right`): boolean | - |  |
