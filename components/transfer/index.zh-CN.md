...
| classNames | 用于自定义组件内部各语义化结构的 class，支持对象或函数 | Record<[SemanticDOM](#semantic-transfer), string> \| (info: { props })=> Record<[SemanticDOM](#semantic-transfer), string> | - |  |
...
| styles | 用于自定义组件内部各语义化结构的行内 style，支持对象或函数 | Record<[SemanticDOM](#semantic-transfer), CSSProperties> \| (info: { props })=> Record<[SemanticDOM](#semantic-transfer), CSSProperties> | - |  |
