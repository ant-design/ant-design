import React, { useCallback, useContext, type ChangeEvent, type CSSProperties } from 'react';
...
import List, { type TransferCustomListBodyProps, type TransferListProps } from './list';
