...
const locales = {
  cn: {
    ...
    source: '源区域元素，仅作用于左侧穿梭框容器样式',
    target: '目标区域元素，仅作用于右侧穿梭框容器样式',
    header:
  ...
  en: {
    ...
    source: 'Source section element, only applies to left transfer section container styles',
    target: 'Target section element, only applies to right transfer section container styles',
    header:
  ...
  return (
    <SemanticPreview
      ...
      semantics={[
        ...
        { name: 'source', desc: locale.source },
        { name: 'target', desc: locale.target },
