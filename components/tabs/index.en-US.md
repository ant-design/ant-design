...
<code src="./demo/style-class.tsx" version="6.0.0">Customize semantic DOM style and class</code>
...
| classNames | Config semantic DOM class, support object or function | [Record<SemanticDOM, string> \| (info: { props })=> Record<SemanticDOM, string>](#semantic-dom) | - | 5.4.0 |
...
| styles | Config semantic DOM style, support object or function | [Record<SemanticDOM, CSSProperties> \| (info: { props })=> Record<SemanticDOM, CSSProperties>](#semantic-dom) | - | 5.4.0 |
