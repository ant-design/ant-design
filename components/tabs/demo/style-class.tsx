...
const classNamesFn = (info: { props: TabsProps }) => {
  ...
  return (
    <Space size={[8, 24]} direction="vertical" style={{ width: '100%' }}>
      ...
      <Flex vertical gap="middle">
        ...
        <Tabs defaultActiveKey="1" items={items} type="card" classNames={classNamesFn as TabsProps['classNames']} />
      </Flex>
      <Flex vertical gap="middle">
        <h4>styles Object</h4>
      ...
      <Flex vertical gap="middle">
        ...
        <Tabs defaultActiveKey="1" items={items} centered styles={stylesFn as TabsProps['styles']} />
      </Flex>
    </Space>
  );
};
