...
export type QRCodeClassNamesType = SemanticClassNamesType<BaseQRCodeProps, QRCodeSemanticName>;
export type QRCodeStylesType = SemanticStylesType<BaseQRCodeProps, QRCodeSemanticName>;
