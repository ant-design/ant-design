    ...
    <Flex gap="small" vertical>
      <Flex gap="small" vertical>
        <Progress
          percent={60}
          size="small"
          indicator={<IconFont type="icon-feiji" style={{ fontSize: 32 }} />}
        />
        <Progress
          percent={90}
          status="active"
          size="small"
          strokeColor="#B7EB8F"
          indicator={<IconFont type="icon-hangzou" style={{ fontSize: 26 }} />}
        />
        <Progress
          percent={70}
          status="exception"
          indicator={<IconFont type="icon-group43" style={{ fontSize: 22 }} />}
        />
        <Progress
          percent={percent}
          strokeColor="#fadb14"
          indicator={<IconFont type="icon-tongchengwaimai" style={{ fontSize: 26 }} />}
          showInfo={false}
        />
      </Flex>
      <Button.Group>
