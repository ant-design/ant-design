...
export type DatePickerSemanticName = 'root' | 'input' | 'suffix';

export type DatePickerClassNamesType<T> = SemanticClassNamesType<T, DatePickerSemanticName>;
export type DatePickerStylesType<T> = SemanticStylesType<T, DatePickerSemanticName>;
