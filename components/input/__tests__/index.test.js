...
describe('should support showCount', () => {
  it('maxLength', () => {
    ...
    expect(wrapper.find('.ant-input-show-count-suffix').innerHTML).toBe('5 / 5');
  });
  ...
  it('control exceed maxLength', () => {
    ...
    expect(wrapper.find('.ant-input-show-count-suffix').innerHTML).toBe('8 / 5');
  });
  ...
  describe('emoji', () => {
    it('should minimize value between emoji length and maxLength', () => {
      ...
      expect(wrapper.find('input').prop('value')).toBe('👀');
      expect(wrapper.find('.ant-input-show-count-suffix').innerHTML).toBe('1 / 1');

      const wrapper1 = mount(<Input maxLength={2} showCount value="👀" />);
      expect(wrapper1.find('.ant-input-show-count-suffix').innerHTML).toBe('1 / 2');
    });
