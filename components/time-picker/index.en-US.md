...
<code src="./demo/change-on-scroll.tsx" version="5.13.0">Change on scroll</code>
...
| changeOnScroll | Trigger selection when scroll the column | boolean | false | 5.13.0 |
...
| needConfirm | Need click confirm button to trigger value change | boolean | - | 5.13.0 |
