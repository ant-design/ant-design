...
describe('Alert', () => {
  ...
  it('should support style-class demo functionality', () => {
    ...
    expect(rootElement.classList).toContain('custom-alert-root');
    expect(iconElement.classList).toContain('custom-alert-icon');
    expect(sectionElement.classList).toContain('custom-alert-section');
    expect(titleElement.classList).toContain('custom-alert-title');
    expect(descriptionElement.classList).toContain('custom-alert-description');
    expect(actionElement.classList).toContain('custom-alert-actions');

    // Check custom styles
    expect(rootElement.style.border).toBe('2px solid rgb(24, 144, 255)');
    expect(rootElement.style.borderRadius).toBe('8px');
    expect(rootElement.style.backgroundColor).toBe('rgb(240, 248, 255)');
    expect(iconElement.style.color).toBe('rgb(24, 144, 255)');
    expect(iconElement.style.fontSize).toBe('18px');
    expect(sectionElement.style.padding).toBe('4px 8px');
    expect(titleElement.style.color).toBe('rgb(24, 144, 255)');
    expect(titleElement.style.fontWeight).toBe('bold');
    expect(descriptionElement.style.color).toBe('rgb(102, 102, 102)');
    expect(descriptionElement.style.fontStyle).toBe('italic');
    expect(actionElement.style.gap).toBe('8px');
  });
});
