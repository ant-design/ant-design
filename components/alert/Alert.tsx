...
const IconNode: React.FC<IconNodeProps> = (props) => {
  ...
  if (icon) {
    ...
    mergedIcon = errorIcon || <CloseCircleFilled />;
  } else if (type === 'info') {
    mergedIcon = infoIcon || <InfoCircleFilled />;
  } else if (type === 'success') {
    mergedIcon = successIcon || <CheckCircleFilled />;
  } else if (type === 'warning') {
    mergedIcon = warningIcon || <ExclamationCircleFilled />;
  }
