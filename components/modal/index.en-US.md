...
| footer | Footer content, set as `footer={null}` when you don't need default buttons | ReactNode \| (originNode: ReactNode, extra: [extraParams](/components/modal-cn#extraparams)) => ReactNode | (OK and Cancel buttons) | renderFunction: 5.9.0 |
...
| footer | Footer content, set as `footer: null` when you don't need default buttons | ReactNode \| (originNode: ReactNode, extra: [extraParams](/components/modal-cn#extraparams)) => ReactNode | - | renderFunction: 5.9.0 |
...
| --- | --- | --- | --- |
| OkBtn | Confirm button | FC | - |
| CancelBtn | Cancel button | FC | - |
