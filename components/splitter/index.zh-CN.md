...
<code src="./demo/style-class.tsx" version="6.0.0">函数形式样式和类名</code>
...
| 参数 | 说明 | 类型 | 默认值 | 版本 |
| --- | --- | --- | --- | --- |
| classNames | 语义化结构 className | [Record<SemanticDOM, string>](#semantic-dom) \| `(params: { props: SplitterProps }) => Record<SemanticDOM, string>` | - | 6.0.0 |
...
| styles | 语义化结构 style | [Record<SemanticDOM, CSSProperties>](#semantic-dom) \| `(params: { props: SplitterProps }) => Record<SemanticDOM, CSSProperties>` | - | 6.0.0 |
