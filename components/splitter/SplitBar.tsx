...
export type ShowCollapsedIconMode = boolean | 'auto';
...
const SplitBar: React.FC<SplitBarProps> = (props) => {
  const {
    ...
    lazy,
    containerSize,
    showStartCollapsedIcon,
    showEndCollapsedIcon,
  } = props;
  ...
  const getVisibilityClass = (mode: ShowCollapsedIconMode): string => {
    switch (mode) {
      case true:
      ...
      {startCollapsible && (
        <div
          className={classNames(
            ...
            getVisibilityClass(showStartCollapsedIcon),
          )}
      ...
      {endCollapsible && (
        <div
          className={classNames(
            ...
            getVisibilityClass(showEndCollapsedIcon),
          )}
