...
| columnDefaultProps | default property of column, property of columnDefaultProps will add to each property of columns, property in columns has a higher priority | [ColumnsType](#Column) | - | 4.15.3 |
