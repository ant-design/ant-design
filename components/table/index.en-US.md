...
| expandIconAsCell | Expand icon as a separate column for the table | boolean | `true` |
| expandIconColumnIndex | expandIconAsCell is false to take effect  Expand icon in the table column index | number | `0` |
