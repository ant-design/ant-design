...
| ~~filterDropdownOpen~~ | 用于控制自定义筛选菜单是否可见, 请使用 `filterDropdownProps.open` 代替 | boolean | - | 4.23.0 |
...
| filterDropdownProps | 自定义下拉属性 | [DropdownProps](/components/dropdown#api) | - | 5.22.0 |
...
| ~~onFilterDropdownOpenChange~~ | 自定义筛选菜单可见变化时调用, 请使用 `filterDropdownProps.onOpenChange` 代替 | function(visible) {} | - | 4.23.0 |
