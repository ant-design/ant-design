...
| components | 覆盖默认的 table 元素，不支持 `virtual` | [TableComponents](https://github.com/react-component/table/blob/75ee0064e54a4b3215694505870c9d6c817e9e4a/src/interface.ts#L129) | - |  |
...
| virtual | 支持虚拟列表，开启后不支持 `components` 自定义 | boolean | - | 5.9.0 |
