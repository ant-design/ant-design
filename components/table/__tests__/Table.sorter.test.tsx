        ...
        children: [
          {
            ...
            sorter: (a, b) => a.estimatedTicketsLeft - b.estimatedTicketsLeft,
            sortDirections: ['descend', 'ascend'],
            render: (text) => `${text} left`,
          },
          {
            title: '[%]',
            dataIndex: 'estimatedTicketsLeftPercentage',
            sorter: (a, b) => a.estimatedTicketsLeftPercentage - b.estimatedTicketsLeftPercentage,
            sortDirections: ['descend', 'ascend'],
