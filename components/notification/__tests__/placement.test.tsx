  ...
  describe('placement', () => {
    it('uses vertical motion for top and bottom placement', async () => {
      ...
      expect(styleText).toMatch(
        /ant-notification-top[\s\S]*ant-notification-fade-enter-start[\s\S]*translate3d\(0,\s*-var\(--ant-margin-xs\),\s*0\)/,
      );
      expect(styleText).toMatch(
        /ant-notification-top[\s\S]*ant-notification-fade-leave-active[\s\S]*translate3d\(0,\s*-var\(--ant-margin-xs\),\s*0\)/,
      );
      expect(styleText).toMatch(
        /ant-notification-bottom[\s\S]*ant-notification-fade-enter-start[\s\S]*translate3d\(0,\s*var\(--ant-margin-xs\),\s*0\)/,
      );
      expect(styleText).toMatch(
        /ant-notification-bottom[\s\S]*ant-notification-fade-leave-active[\s\S]*translate3d\(0,\s*var\(--ant-margin-xs\),\s*0\)/,
      );
    });
