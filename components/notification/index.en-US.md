...
| role | The semantics of notification content recognized by screen readers. The default value is alert. In this case, the screen reader will immediately interrupt other content currently being read and read the notification content instead | `alert \| status` | `alert` |
