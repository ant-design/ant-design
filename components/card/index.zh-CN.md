...
| classNames | 配置卡片内置模块的 className | `header?: string; body?: string; extra?: string; title?: string; actions?: string; cover?: string;` | - | 5.13.0 |
| styles | 配置卡片内置模块的 style | `header?: CSSProperties; body?: CSSProperties; extra?: CSSProperties; title?: CSSProperties; actions?: CSSProperties; cover?: CSSProperties;` | - | 5.13.0 |
