...
<code src="./demo/style-class.tsx" debug>Semantic styles</code>
...
| classNames | Semantic DOM class | [Record<SemanticDOM, string>](#semantic-dom) | - | 5.14.0 |
| styles | Semantic DOM style | [Record<SemanticDOM, CSSProperties>](#semantic-dom) | - | 5.14.0 |
