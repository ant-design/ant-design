...
| classNames | Config Card build-in module's className | `header?: string; body?: string; extra?: string; title?: string; actions?: string; cover?: string;` | - | 5.13.0 |
| styles | Config Card build-in module's style | `header?: CSSProperties; body?: CSSProperties; extra?: CSSProperties; title?: CSSProperties; actions?: CSSProperties; cover?: CSSProperties;` | - | 5.13.0 |
