...
### [App Package Component](https://ant.design/components/app-cn) can be used to simplify the problem of useMessage and other methods that need to manually implant contextHolder
