...
| customRequest | 通过覆盖默认的上传行为，可以自定义自己的上传实现 | ( options: [RequestOptions](#request-options), info: { defaultRequest: (option: [RequestOptions](#request-options)) => void \| { abort: () => void }; } ) => void \| { abort: () => void } | - | defaultRequest: 5.28.0 | 5.27.0 |
