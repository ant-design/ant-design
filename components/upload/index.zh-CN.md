...
| itemRender | 自定义上传列表项 | (originNode: ReactElement, file: UploadFile, fileList: object\[], actions: { download: function, preview: function, remove: function }, info: { error: ReactNode }) => React.ReactNode | - | 4.16.0（`info`: 6.4.0） |
