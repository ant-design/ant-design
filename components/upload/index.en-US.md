...
| folder | Support upload whole directory ([caniuse](https://caniuse.com/#feat=input-file-directory))([Difference with directory](#Differences-between-directory-and-folder)) | boolean | false | 5.27.0 |
...
### Differences between directory and folder
