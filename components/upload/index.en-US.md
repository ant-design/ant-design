...
| onClickItem | event triggered when an element is clicked | (file: UploadFile) => void | - |  |
...
| iconActionRender | Customize the action of displaying icon, that is, preview and delete the small icon | (file: UploadFile, icons: IconAction, events: IconActionEvents) => JSX.Element | - |  |
