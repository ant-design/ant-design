...
| folder | Support upload whole directory ([caniuse](https://caniuse.com/#feat=input-file-directory))([Difference with directory](#faq-folder-vs-directory)) | boolean | false | 5.27.0 |
...
### Differences between directory and folder {#faq-folder-vs-directory}

directory filters out any files not explicitly accepted and is deprecated, while folder does no filtering and preserves native behavior.
