...
| color | 设置按钮的颜色 | `default` \| `primary` \| `danger` \| `blue` \| `purple` \| `cyan` \| `green` \| `magenta` \| `pink` \| `red` \| `orange` \| `yellow` \| `volcano` \| `geekblue` \| `lime` \| `gold` | - | `default`、`primary` 和 `danger`: 5.21.0, 其他: 5.23.0 |
