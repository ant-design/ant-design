...
| --- | --- | --- | --- | --- |
| autoInsertSpace | We provide a space between two Chinese characters by default, which can be removed by setting `autoInsertSpace` to `false`. | boolean | `true` | 5.17.0 |
