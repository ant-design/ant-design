...
| color | Set button color | `default` \| `primary` \| `danger` \| `blue` \| `purple` \| `cyan` \| `green` \| `magenta` \| `pink` \| `red` \| `orange` \| `yellow` \| `volcano` \| `geekblue` \| `lime` \| `gold` | - | `default`, `primary` and `danger`: 5.21.0, others: 5.23.0 |
