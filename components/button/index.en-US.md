...
| --- | --- | --- | --- | --- |
| autoInsertSpace | We provide a space between two Chinese characters by default, which can be remove by setting `autoInsertSpace` to `false`. | boolean | `true` | 5.17.0 |
