...
| content | 水印文字内容 | string \| [WatermarkText](#watermarktext) \| (string \| [WatermarkText](#watermarktext))[] | - | WatermarkText: 6.4.0 |
...
| 参数 | 说明 | 类型 | 默认值 | 版本 |
| --- | --- | --- | --- | --- |
| font | 自定义单行文字样式 | [Font](#font) | - | 6.4.0 |
| text | 单行文字内容 | string | - | 6.4.0 |
