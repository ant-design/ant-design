...
| content | Watermark text content | string \| [WatermarkText](#watermarktext) \| (string \| [WatermarkText](#watermarktext))[] | - | WatermarkText: 6.4.0 |
...
| Property | Description | Type | Default | Version |
| --- | --- | --- | --- | --- |
| font | Custom line text style | [Font](#font) | - | 6.4.0 |
| text | Line text | string | - | 6.4.0 |
