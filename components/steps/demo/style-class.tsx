  ...
  return (
    <Space size={[8, 24]} direction="vertical" style={{ width: '100%' }}>
      <Flex vertical gap="middle">
        ...
        <Steps current={1} items={items} classNames={classNamesObject} />
      </Flex>
      <Flex vertical gap="middle">
        <h4>classNames Function</h4>
        <Steps current={1} items={items} type="navigation" classNames={classNamesFn} />
      </Flex>
      <Flex vertical gap="middle">
        <h4>styles Object</h4>
      ...
      <Flex vertical gap="middle">
        ...
        <Steps current={1} items={items} styles={stylesFn} />
      </Flex>
    </Space>
  );
};
