...
| card | 设置 Card 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?: [CardProps\["classNames"\]](/components/card-cn#semantic-dom), styles?: [CardProps\["styles"\]](/components/card-cn#semantic-dom), variant?: [CardProps\["variant"\]](/components/card-cn#api) } | - | 5.7.0, `classNames` 和 `styles`: 5.14.0, `variant`: 5.24.0 |
...
| cascader | 设置 Cascader 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?: [CascaderConfig\["classNames"\]](/components/cascader-cn#semantic-dom), styles?: [CascaderConfig\["styles"\]](/components/cascader-cn#semantic-dom), variant?: [CascaderConfig\["variant"\]](/components/cascader-cn#api), expandIcon?: React.ReactNode, loadingIcon?: React.ReactNode, searchIcon?: React.ReactNode, clearIcon?: React.ReactNode, removeIcon?: React.ReactNode, suffixIcon?: React.ReactNode } | - | 5.7.0, `variant`: 5.13.0, `classNames` 和 `styles`: 6.0.0, `expandIcon`, `loadingIcon`, `searchIcon`, `clearIcon`, `removeIcon`, `suffixIcon`: 6.4.0 |
...
| colorPicker | 设置 ColorPicker 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?: [ColorPickerConfig\["classNames"\]](/components/color-picker-cn#semantic-dom), styles?: [ColorPickerConfig\["styles"\]](/components/color-picker-cn#semantic-dom), arrow?: [ColorPickerConfig\["arrow"\]](/components/color-picker-cn#api) } | - | 5.7.0, `arrow`: 6.3.0 |
...
| divider | 设置 Divider 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?: [DividerProps\["classNames"\]](/components/divider-cn#semantic-dom), styles?: [DividerProps\["styles"\]](/components/divider-cn#semantic-dom) } | - | 5.10.0, `classNames` 和 `styles`: 6.0.0 |
| drawer | 设置 Drawer 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?: [DrawerProps\["classNames"\]](/components/drawer-cn#semantic-dom), styles?: [DrawerProps\["styles"\]](/components/drawer-cn#semantic-dom), closeIcon?: ReactNode, closable?: [DrawerProps\["closable"\]](/components/drawer-cn#api), mask?: [DrawerProps\["mask"\]](/components/drawer-cn#api), focusable?: [DrawerProps\["focusable"\]](/components/drawer-cn#api)} | - | 5.7.0, `classNames` 和 `styles`: 5.10.0, `closeIcon`: 5.14.0, `mask`: 6.0.0, `mask.closable`: 6.3.0, `focusable`: 6.4.0 |
...
| input | 设置 Input 组件的通用属性 | { autoComplete?: string, className?: string, style?: React.CSSProperties,classNames?:[InputConfig\["classNames"\]](/components/input-cn#semantic-input), styles?: [InputConfig\["styles"\]](/components/input-cn#semantic-input), allowClear?: boolean \| { clearIcon?: ReactNode, disabled?: boolean }, variant?: [InputConfig\["variant"\]](/components/input-cn#api) } | - | 5.7.0, `allowClear`: 5.15.0, `variant`: 5.13.0, `allowClear.disabled`: 6.4.0 |
| inputNumber | 设置 Input 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?: [InputNumberConfig\["classNames"\]](/components/input-number-cn#semantic-dom), styles?: [InputNumberConfig\["styles"\]](/components/input-number-cn#semantic-dom), variant?: [InputNumberConfig\["variant"\]](/components/input-number-cn#api) } | - | 5.19.0, `classNames` 和 `styles`: 6.0.0 |
...
| textArea | 设置 TextArea 组件的通用属性 | { autoComplete?: string, className?: string, style?: React.CSSProperties,classNames?:[TextAreaConfig\["classNames"\]](/components/input-cn#semantic-textarea), styles?: [TextAreaConfig\["styles"\]](/components/input-cn#semantic-textarea), allowClear?: boolean \| { clearIcon?: ReactNode }, variant?: [TextAreaConfig\["variant"\]](/components/input-cn#inputtextarea) } | - | 5.15.0, `variant`: 5.15.0 |
...
| menu | 设置 Menu 组件的通用属性 | { className?: string, style?: React.CSSProperties, expandIcon?: ReactNode \| props => ReactNode, classNames?: [MenuConfig\["classNames"\]](/components/menu-cn#semantic-dom), styles?: [MenuConfig\["styles"\]](/components/menu-cn#semantic-dom) } | - | 5.7.0, `expandIcon`: 5.15.0, `classNames` 和 `styles`: 6.0.0 |
| mentions | 设置 Mentions 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?:[MentionsConfig\["classNames"\]](/components/mentions-cn#semantic-dom), styles?: [MentionsConfig\["styles"\]](/components/mentions-cn#semantic-dom), allowClear?: boolean \| { clearIcon?: ReactNode, disabled?: boolean }, variant?: [MentionsConfig\["variant"\]](/components/mentions-cn#api) } | - | 5.7.0, `variant`: 5.13.0, `classNames` 和 `styles`: 6.0.0, `allowClear`: 6.4.0 |
| message | 设置 Message 组件的通用属性 | 参见 [Message](/components/message-cn#api) | - | 5.7.0 |
| modal | 设置 Modal 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?: [ModalProps\["classNames"\]](/components/modal-cn#semantic-dom), styles?: [ModalProps\["styles"\]](/components/modal-cn#semantic-dom), closeIcon?: React.ReactNode, closable?: [ModalProps\["closable"\]](/components/modal-cn#api), centered?: [ModalProps\["centered"\]](/components/modal-cn#api), okButtonProps?: [ModalProps\["okButtonProps"\]](/components/modal-cn#api), cancelButtonProps?: [ModalProps\["cancelButtonProps"\]](/components/modal-cn#api), mask?: [ModalProps\["mask"\]](/components/modal-cn#api), focusable?: [ModalProps\["focusable"\]](/components/modal-cn#api), infoIcon?: React.ReactNode, successIcon?: React.ReactNode, errorIcon?: React.ReactNode, warningIcon?: React.ReactNode } | - | 5.7.0, `classNames` 和 `styles`: 5.10.0, `closeIcon`: 5.14.0, `closable`: 5.16.0, `centered`: 5.24.0, `okButtonProps`, `cancelButtonProps` 和 `mask`: 6.0.0, `mask.closable`: 6.3.0, `focusable`, `infoIcon`, `successIcon`, `errorIcon` 和 `warningIcon`: 6.4.0 |
...
| select | 设置 Select 组件的通用属性 | { className?: string, showSearch?: [SelectProps\["showSearch"\]](/components/select-cn#api), style?: React.CSSProperties, classNames?: [SelectConfig\["classNames"\]](/components/select-cn#semantic-dom), styles?: [SelectConfig\["styles"\]](/components/select-cn#semantic-dom), variant?: [SelectConfig\["variant"\]](/components/select-cn#api), allowClear?: boolean \| { clearIcon?: ReactNode }, clearIcon?: React.ReactNode, loadingIcon?: React.ReactNode, menuItemSelectedIcon?: React.ReactNode, removeIcon?: React.ReactNode, suffixIcon?: React.ReactNode } | - | 5.7.0, `variant`: 5.13.0, `classNames` 和 `styles`: 6.0.0, `allowClear`, `clearIcon`, `loadingIcon`, `menuItemSelectedIcon`, `removeIcon`, `suffixIcon`: 6.4.0 |
...
| steps | 设置 Steps 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?:[StepsConfig\["classNames"\]](/components/steps-cn#semantic-dom), styles?: [StepsConfig\["styles"\]](/components/steps-cn#semantic-dom) } | - | 5.10.0, `classNames` 和 `styles`: 6.0.0 |
...
| tabs | 设置 Tabs 组件的通用属性 | { className?: string, style?: React.CSSProperties, indicator?: { size?: GetIndicatorSize, align?: `start` \| `center` \| `end` }, more?: [TabsConfig\["more"\]](/components/tabs-cn#api), moreIcon?: ReactNode, addIcon?: ReactNode, removeIcon?: ReactNode, classNames?: [TabsConfig\["classNames"\]](/components/tabs-cn#semantic-dom), styles?: [TabsConfig\["styles"\]](/components/tabs-cn#semantic-dom) } | - | 5.7.0, `moreIcon` and `addIcon`: 5.14.0, `removeIcon`: 5.15.0, `more`: 5.17.0, `classNames` 和 `styles`: 6.0.0 |
| tag | 设置 Tag 组件的通用属性 | { className?: string, style?: React.CSSProperties, closeIcon?: React.ReactNode, variant?: [TagProps\["variant"\]](/components/tag-cn#api), classNames?: [TagProps\["classNames"\]](/components/tag-cn#semantic-dom), styles?: [TagProps\["styles"\]](/components/tag-cn#semantic-dom) } | - | 5.7.0, `closeIcon`: 5.14.0, `variant`: 6.0.0, `classNames` 和 `styles`: 6.0.0 |
...
| timePicker | 设置 TimePicker 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?: [TimePickerConfig\["classNames"\]](/components/time-picker-cn#semantic-dom), styles?: [TimePickerConfig\["styles"\]](/components/time-picker-cn#semantic-dom), variant?: [TimePickerConfig\["variant"\]](/components/time-picker-cn#api), suffixIcon?: React.ReactNode, allowClear?: boolean \| { clearIcon?: ReactNode }, clearIcon?: React.ReactNode } | - | 5.7.0, `variant`: 5.13.0, `suffixIcon`: 6.3.0, `allowClear`, `clearIcon`: 6.4.0 |
...
| treeSelect | 设置 TreeSelect 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?: [TreeSelectConfig\["classNames"\]](/components/tree-select-cn#semantic-dom), styles?: [TreeSelectConfig\["styles"\]](/components/tree-select-cn#semantic-dom), variant?: [TreeSelectConfig\["variant"\]](/components/tree-select-cn#api), switcherIcon?: [TreeSelect\["switcherIcon"\]](/components/tree-select-cn#api)} | - | 5.19.0, `switcherIcon`: 5.28.0, `classNames` 和 `styles`: 6.0.0 |
| typography | 设置 Typography 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?: [TypographyConfig\["classNames"\]](/components/typography-cn#semantic-dom), styles?: [TypographyConfig\["styles"\]](/components/typography-cn#semantic-dom) } | - | 5.7.0, `classNames` 和 `styles`: 6.4.0 |
