...
| autoComplete | 设置 AutoComplete 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?: [AutoCompleteConfig\["classNames"\]](/components/auto-complete-cn#semantic-dom), styles?: [AutoCompleteConfig\["styles"\]](/components/auto-complete-cn#semantic-dom) } | - | 6.0.0 |
