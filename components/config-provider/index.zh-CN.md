...
| input | 设置 Input 组件的通用属性 | { autoComplete?: string, spellCheck?: boolean } | - | 4.2.0 |
| search | 设置 Input.Search 组件的通用属性 | { spellCheck?: boolean } | - | 4.2.0 |
| textarea | 设置 Input.Textarea 组件的通用属性 | { spellCheck?: boolean } | - | 4.2.0 |
| inputNumber | 设置 InputNumber 组件的通用属性 | { spellCheck?: boolean } | - | 4.2.0 |
