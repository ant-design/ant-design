...
| divider | 设置 Divider 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?: [DividerProps\["classNames"\]](/components/divider-cn#semantic-dom), styles?: [DividerProps\["styles"\]](/components/divider-cn#semantic-dom) } | - | `classNames` 和 `styles`: 6.0.0 |
...
| inputNumber | 设置 Input 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?: [InputNumberConfig\["classNames"\]](/components/input-number-cn#semantic-dom), styles?: [InputNumberConfig\["styles"\]](/components/input-number-cn#semantic-dom), variant?: [InputNumberConfig\["variant"\]](/components/input-number-cn#api) } | - | `variant`: 5.13.0 |
...
| steps | 设置 Steps 组件的通用属性 | { className?: string, style?: React.CSSProperties, classNames?:[StepsConfig\["classNames"\]](/components/steps-cn#semantic-dom), styles?: [StepsConfig\["styles"\]](/components/steps-cn#semantic-dom) } | - | `classNames` 和 `styles`: 6.0.0 |
