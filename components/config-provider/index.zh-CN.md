...
| popupOverflow | Select 类组件弹层展示逻辑，默认为可视区域滚动，可配置成滚动区域滚动 | 'viewport' \| 'scroll' <InlinePopover previewURL="https://user-images.githubusercontent.com/5378891/230342024-b93027ce-bdaa-496d-bcd2-76c0bb1d1fe6.png"></InlinePopover> | 'viewport' | 5.5.0 |
