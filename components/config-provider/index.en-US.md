...
| cascader | Set Cascader common props | { className?: string, style?: React.CSSProperties, classNames?: [CascaderProps\["classNames"\]](/components/cascader#api), styles?: [CascaderProps\["styles"\]](/components/cascader#api) } | - | 5.7.0, `classNames` and `styles`: 5.25.0 |
