...
| inputPassword | Set Password common props | { className?: string, style?: React.CSSProperties, classNames?: [InputPasswordConfig\["classNames"\]](/components/input#semantic-password), styles?: [InputPasswordConfig\["styles"\]](/components/input#semantic-password), iconRender?: [InputPaswordProps\["iconRender"\]](/components/input/#inputpassword) } | - | 6.4.0 |
