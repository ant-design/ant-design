...
| direction | to set direction of all elements underneath itself, set `rtl` to view underneath components right-to-left styled | string: 'ltr', 'rtl', 'auto' | ltr | 3.21.5 |
