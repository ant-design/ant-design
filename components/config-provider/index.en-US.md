...
| message | Set Message common props | { className?: string, style?: React.CSSProperties, rtl?: boolean, classNames?: [MessageConfig\["classNames"\]](/components/message#semantic-dom), styles?: [MessageConfig\["styles"\]](/components/message#semantic-dom) } | - | 5.7.0, `classNames` and `styles`: 6.0.0, `rtl`: 6.4.0 |
