...
| datePicker | Set datePicker common props | { className?: string, style?: React.CSSProperties, classNames?: [DatePickerConfig\["classNames"\]](/components/date-picker#semantic-dom), styles?: [DatePickerConfig\["styles"\]](/components/date-picker#semantic-dom), suffixIcon?: React.ReactNode, allowClear?: boolean \| { clearIcon?: ReactNode }, clearIcon?: React.ReactNode } | - | 5.7.0, `suffixIcon`: 6.3.0, `allowClear`, `clearIcon`: 6.4.0 |
...
| select | Set Select common props | { className?: string, showSearch?: boolean, style?: React.CSSProperties, classNames?: [SelectConfig\["classNames"\]](/components/select#semantic-dom), styles?: [SelectConfig\["styles"\]](/components/select#semantic-dom), allowClear?: boolean \| { clearIcon?: ReactNode }} | - | 5.7.0, `classNames` and `styles`: 6.0.0, `allowClear`: 6.4.0 |
...
| upload | Set Upload common props | { className?: string, style?: React.CSSProperties, classNames?:[UploadConfig\["classNames"\]](/components/upload#semantic-dom), styles?: [UploadConfig\["styles"\]](/components/upload#semantic-dom), customRequest?: [Upload\["customRequest"\]](/components/upload#api), progress?: [ProgressProps](/components/progress#api), accept?: [Upload\["accept"\]](/components/upload#api), showUploadList?: [Upload\["showUploadList"\]](/components/upload#api) } | - | 5.7.0, `customRequest`: 5.27.0, `classNames` and `styles`: 6.0.0, `accept`, `progress` and `showUploadList`: 6.4.0 |
