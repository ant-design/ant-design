...
You can modify the breakpoints values using by modifying `ScreenXS` to `ScreenXXL` with [theme customization](https://ant.design/docs/react/customize-theme) (since 5.1.0).
