...
describe('Grid.Server', () => {
  it('use compatible gap logic', () => {
    ...
    expect((container.querySelector('.ant-row') as HTMLElement)?.style.marginTop).toBe('-8px');
    expect((container.querySelector('.ant-row') as HTMLElement)?.style.marginBottom).toBe('-8px');
