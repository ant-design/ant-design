...
您可以使用 [主题定制](/docs/react/customize-theme-cn) 修改 `screen[XS|SM|MD|LG|XL|XXL]` 来修改断点值（自 5.1.0 起，[沙盒演示](https://codesandbox.io/s/antd-reproduction-template-forked-bjojbx?file=/index.js)）。
