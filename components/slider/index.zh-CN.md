...
| 参数 | 说明 | 类型 | 默认值 | 版本 |
| --- | --- | --- | --- | --- |
| autoFocus | 组件挂载时是否自动聚焦 | boolean | false |  |
...
| trackStyle | Slider 已滑过 `value` 的样式 | CSSProperties | - |  |
| railStyle | Slider 整体的样式 | CSSProperties \| CSSProperties[] | - |  |
| handleStyle | Slider 控制点的样式 | CSSProperties \| CSSProperties[] | - |  |
