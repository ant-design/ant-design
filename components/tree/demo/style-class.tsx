...
import type { TreeProps, TreeClassNamesType, TreeStylesType } from 'antd';
...
const staticClassNames: TreeClassNamesType = {
...
const staticStyles: TreeStylesType = {
...
const dynamicClassNames: TreeClassNamesType = ({ props }) => ({
...
const dynamicStyles: TreeStylesType = ({ props }) => ({
  root: {
