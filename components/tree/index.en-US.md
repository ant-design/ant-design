...
| switcherIcon | customize collapse/expand icon of tree node | React.ReactNode | - |
| caretDownIcon | customize caret down icon of tree node | React.ReactNode | No effect when `switcherIcon` provided |
| loadingIcon | customize loading icon of tree node | React.ReactNode | - |
