...
| classNames | Customize class for each semantic structure inside the component. Supports object or function. | Record<[SemanticDOM](#semantic-tree), string> \| (info: { props }) => Record<[SemanticDOM](#semantic-tree), string> | - | 6.0.0 |
...
| styles | Customize inline style for each semantic structure inside the component. Supports object or function. | Record<[SemanticDOM](#semantic-tree), CSSProperties> \| (info: { props }) => Record<[SemanticDOM](#semantic-tree), CSSProperties> | - | 6.0.0 |
