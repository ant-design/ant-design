...
import type { AntTreeNodeProps, TreeClassNamesType, TreeStylesType } from '../Tree';
...
describe('Tree', () => {
  ...
  describe('semantic DOM', () => {
    ...
    it('should support static classNames and styles', () => {
      const testClassNames: TreeClassNamesType = {
      ...
      const testStyles: TreeStylesType = {
    ...
    it('should support function-based classNames and styles', () => {
      const testClassNames: TreeClassNamesType = ({ props }) => ({
      ...
      const testStyles: TreeStylesType = ({ props }) => ({
        root: {
