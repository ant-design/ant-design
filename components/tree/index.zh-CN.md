...
| classNames | 用于自定义组件内部各语义化结构的 class，支持对象或函数 | Record<[SemanticDOM](#semantic-tree), string> \| (info: { props }) => Record<[SemanticDOM](#semantic-tree), string> | - | 6.0.0 |
...
| styles | 用于自定义组件内部各语义化结构的行内 style，支持对象或函数 | Record<[SemanticDOM](#semantic-tree), CSSProperties> \| (info: { props }) => Record<[SemanticDOM](#semantic-tree), CSSProperties> | - | 6.0.0 |
