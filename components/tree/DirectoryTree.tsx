...
const InternalDirectoryTree = React.forwardRef<RcTree, DirectoryTreeProps>(
  ({ defaultExpandAll, defaultExpandParent, defaultExpandedKeys, ...props }, ref) => {
    // Shift click usage
...
type DirectoryTreeType = (<T extends BasicDataNode | DataNode = DataNode>(
  props: React.PropsWithChildren<DirectoryTreeProps<T>> & { ref?: React.Ref<RcTree> },
) => React.ReactElement) & {
  displayName?: string;
};

const DirectoryTree = Object.assign(InternalDirectoryTree as DirectoryTreeType, {});
