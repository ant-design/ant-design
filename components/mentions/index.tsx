...
export type MentionsClassNamesType = SemanticClassNamesType<BaseMentionProps, SemanticName>;
export type MentionsStylesType = SemanticStylesType<BaseMentionProps, SemanticName>;

export interface BaseMentionProps {
  loading?: boolean;
  status?: InputStatus;
...
export interface MentionProps
  extends Omit<RcMentionsProps, 'suffix' | 'classNames' | 'styles'>,
    BaseMentionProps {
...
const InternalMentions = React.forwardRef<MentionsRef, MentionProps>((props, ref) => {
  ...
  const mergedProps = React.useMemo<BaseMentionProps>(() => {
    return {
      ...props,
  ...
  }, [props, mergedDisabled, mergedStatus, loading, options, customVariant]);
