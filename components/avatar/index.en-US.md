...
| Property | Description | Type | Default | Version |
| --- | --- | --- | --- | --- |
| max | Set maximum display related configurations, Before `5.18.0` you can use [parameters](https://github.com/ant-design/ant-design/blob/master/components/avatar/group.tsx#L37-L44) | `{ count?: number; style?: CSSProperties; popover?: PopoverProps }` | - | 5.18.0 |
