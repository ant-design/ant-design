...
| size | The size of the avatar | number \| `large` \| `middle` \| `small` \| { xs: number, sm: number, ...} | `middle` | 4.7.0 |
...
| size | The size of the avatar | number \| `large` \| `middle` \| `small` \| { xs: number, sm: number, ...} | `middle` | 4.8.0 |
