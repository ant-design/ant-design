...
const localeValues: Locale = {
  ...
  ColorPicker: {
    label: 'Spalvų parinkiklis',
    labelDescription: '2D slankiklis',
    clearLabel: 'Išvalyti spalvą',
    presetEmpty: 'Tuščia',
    ...
    hue: 'Atspalvis',
    alpha: 'Alfa',
    formatSelect: 'Spalvų formatas',
    hexInput: 'Hex',
    hsbInput: 'HSB',
    hsbHue: 'Atspalvis',
    hsbSaturation: 'Sodrumas',
    hsbBrightness: 'Šviesumas',
    rgbInput: 'RGB',
    rgbRed: 'Raudona',
    rgbGreen: 'Žalia',
    rgbBlue: 'Mėlyna',
