...
const localeValues: Locale = {
  ...
  ColorPicker: {
    label: 'Selettore colore',
    labelDescription: 'Slider 2D',
    clearLabel: 'Cancella colore',
    presetEmpty: 'Vuoto',
    ...
    hue: 'Tonalità',
    alpha: 'Alfa',
    formatSelect: 'Formato colore',
    hexInput: 'Hex',
    hsbInput: 'HSB',
    hsbHue: 'Tonalità',
    hsbSaturation: 'Saturazione',
    hsbBrightness: 'Luminosità',
    rgbInput: 'RGB',
    rgbRed: 'Rosso',
    rgbGreen: 'Verde',
    rgbBlue: 'Blu',
