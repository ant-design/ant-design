...
const localeValues: Locale = {
  ...
  Table: {
    ...
    selectAll: 'Seleccionar pàgina actual',
    selectInvert: 'Invertir pàgina actual',
    selectionAll: 'Seleccionar-ho tot',
    sortTitle: 'Ordenar',
    expand: 'Ampliar fila',
    collapse: 'Plegar fila',
    triggerDesc: 'Ordre descendent',
    triggerAsc: 'Ordre ascendent',
    cancelSort: 'Cancel·lar ordre',
  },
  Modal: {
    okText: 'D’acord',
  ...
  Transfer: {
    ...
    itemsUnit: 'ítems',
    remove: 'Eliminar',
    selectCurrent: 'Seleccionar pàgina actual',
    removeCurrent: 'Eliminar pàgina actual',
  ...
  Form: {
    defaultValidateMessages: {
      ...
      date: {
        ...
        parse: '${label} no es pot convertir a data',
