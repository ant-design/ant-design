...
const localeValues: Locale = {
  ...
  ColorPicker: {
    label: 'Kolore-hautatzailea',
    labelDescription: '2D irristailua',
    clearLabel: 'Garbitu kolorea',
    presetEmpty: 'Hustu',
    transparent: 'Gardena',
    ...
    hue: 'Ñabardura',
    alpha: 'Alfa',
    formatSelect: 'Kolore-formatua',
    hexInput: 'Hex',
    hsbInput: 'HSB',
    hsbHue: 'Ñabardura',
    hsbSaturation: 'Saturazioa',
    hsbBrightness: 'Distira',
    rgbInput: 'RGB',
    rgbRed: 'Gorria',
    rgbGreen: 'Berdea',
    rgbBlue: 'Urdina',
