...
```jsx
import { PageHeader, Menu, Dropdown, Button, Tag, Typography, Row } from '@allenai/varnish';
...
const content = (
  <>
    <Paragraph>
      Varnish interprets the color system into two levels: a system-level color system and a
      product-level color system.
    </Paragraph>
    <Paragraph>
      Varnish&#x27;s design team preferred to design with the HSB color model, which makes it
