...
import RcTreeSelect, {
  ...
  SHOW_PARENT,
  TreeNode,
  type TreeSelectProps as RcTreeSelectProps,
} from 'rc-tree-select';
import { type BaseOptionType, type DefaultOptionType } from 'rc-tree-select/lib/TreeSelect';
...
import { type AntTreeNodeProps, type TreeProps } from '../tree';
