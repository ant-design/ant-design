...
export type TreeSelectClassNamesType = Partial<Record<SemanticName, string>> & {
  popup?: Partial<Record<PopupSemantic, string>>;
};
export type TreeSelectStylesType = Partial<Record<SemanticName, React.CSSProperties>> & {
...
const InternalTreeSelect = <ValueType = any, OptionType extends DataNode = DataNode>(
  ...
  const mergedProps = React.useMemo<BaseTreeSelectProps>(() => {
    return {
      ...props,
      size: mergedSize,
  ...
  }, [props, mergedSize, mergedDisabled, mergedStatus, variant]);
