...
| tooltipIcon | Config tooltip icon | ReactNode | `<QuestionCircleOutlined />` | 6.2.0 |
| tooltipProps | Config tooltip props | [TooltipProps](/components/tooltip#api) | - | 6.2.0 |
...
| tooltip | Config tooltip content | ReactNode | - | 4.7.0 |
| tooltipIcon | Config tooltip icon | ReactNode | `<QuestionCircleOutlined />` | 6.2.0 |
| tooltipProps | Config tooltip props | [TooltipProps](/components/tooltip#api) | - | 6.2.0 |
