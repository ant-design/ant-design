...
| itemReferable | Field instance can be get by `getFieldInstance` | boolean | false | 4.4.0 |
...
| referable | Field instance can be get by `getFieldInstance` | boolean | false | 4.4.0 |
...
| --- | --- | --- |
| getFieldInstance | Get field instance which config `referable` | (name: [NamePath](#NamePath)) => any | 4.4.0 |
