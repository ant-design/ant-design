...
| customFeedbackIcons | Used with `hasFeedback`, this option replaces the feedback icons with the given ones. | ({status:ValidateStatus, errors: ReactNode, warnings: ReactNode}) => Record<ValidateStatus,ReactNode> | - | 5.7.3 |
