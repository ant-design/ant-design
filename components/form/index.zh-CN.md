...
| customFeedbackIcons | 与“hasFeedback”一起使用，此选项将反馈图标替换为给定的图标。 | ({status:ValidateStatus, errors: ReactNode, warnings: ReactNode}) => Record<ValidateStatus,ReactNode> | - | 5.7.3 |
