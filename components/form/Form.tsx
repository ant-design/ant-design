...
export interface FormProps<Values = any> extends Omit<RcFormProps<Values>, 'form'> {
  ...
  size?: SizeType;
  disabled?: boolean;
  scrollToFirstError?: ExtendedOptions | boolean;
...
const InternalForm: React.ForwardRefRenderFunction<FormRef, FormProps> = (props, ref) => {
  ...
  const scrollToField = (options: boolean | ExtendedOptions, fieldName: InternalNamePath) => {
    if (options) {
      let defaultScrollToFirstError: ExtendedOptions = { block: 'nearest' };
