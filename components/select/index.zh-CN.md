...
<code src="./demo/option-render.tsx" version=">=5.11.0">自定义渲染下拉选项</code>
...
| optionRender | 自定义渲染下拉选项 | (oriOption: FlattenOptionData\<BaseOptionType\> , info: { index: number }) => React.ReactNode | - | 5.11.0 |
