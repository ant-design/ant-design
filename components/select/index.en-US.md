...
| onBlurRemoveSpace | Whether to remove space when losing focus | boolean | true |  |
| onBlurAddValue | Whether to add the input value to the selected item when losing focus | boolean | true |  |
