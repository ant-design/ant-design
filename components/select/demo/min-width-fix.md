...
Test for the min-width behavior fix where `popupMatchSelectWidth` should set `min-width` by default.

## zh-CN

测试最小宽度行为修复，`popupMatchSelectWidth` 默认应该设置 `min-width`。
