...
const ServerError: React.FC = () => (
  <svg width="254" height="294">
    ...
    <g fill="none">
      ...
      <path
        fill="#FFF"
        d="M40 132.1a8.3 8.3 0 1 1-16.6-1.7 8.3 8.3 0 0 1 16.6 1.7m.1 28.7a5.7 5.7 0 1 1-11.3-1.1 5.7 5.7 0 0 1 11.3 1.1M58 144.6a5.7 5.7 0 1 1-11.4-1.2 5.7 5.7 0 0 1 11.4 1.2M99.7 27.4h30a4.6 4.6 0 1 0 0-9.2h-30a4.6 4.6 0 0 0 0 9.2M111 46h30a4.6 4.6 0 1 0 0-9.3h-30a4.6 4.6 0 1 0 0 9.3m2.5-18.6h16a4.6 4.6 0 1 0 0 9.3h-16a4.6 4.6 0 0 0 0-9.3m36.7 42.7h-4a4.8 4.8 0 0 1-4.8-4.8 4.8 4.8 0 0 1 4.8-4.8h4a4.8 4.8 0 0 1 4.7 4.8 4.8 4.8 0 0 1-4.7 4.8"
      />
      {/* <path fill="#FF603B" d="M171.7 30.2a29.7 29.7 0 1 1 59.3 0 29.7 29.7 0 0 1-59.3 0Z" /> */}
      ...
      />
      <path stroke="#DB836E" d="m99.2 73.6-.9 1.7-.3 4.3h-2.2" />
      <path stroke="#5C2552" d="M100 73.3s1.7-.7 2.4.5" />
      <path stroke="#DB836E" d="M81.4 73s.4-1 1-.6c.7.4 1.4 1.4.6 2s.2 1.6.2 1.6" />
      <path stroke="#5C2552" d="M92.3 71.7s1.9 1.1 4.2 1" />
      <path
        stroke="#DB836E"
        d="M92.7 80.6s2.3 1.2 4.4 1.2m-3.4 1.4s1 .4 1.5.3M83.7 80s1.8 6.6 9.2 8"
      />
      <path stroke="#E4EBF7" d="M95.5 91.7s-1 2.8-8.2 2c-7.3-.6-10.3-5-10.3-5" />
      <path
        fill="#FFF"
      ...
      />
      <path stroke="#E4EBF7" d="M108.5 105.2s1.7 2.7-2.4 30.5c2.4 2.2 1 6-.2 7.5" />
      <path
        fill="#FFC6A0"
      ...
      <path
        stroke="#648BD8"
        d="M64.6 218.9c1.2 0 4.2-2.1 7.2-5.1m24.2 8.7s3-1.1 6.4-4m-5.4.9s2.9-1.2 6.3-4m-40.1 6.7s2.7-.6 6.7-3.5m5-72.4c-.3 3.2.3 8.8-4.5 9.4m22.8-11.3s.1 14.6-1.4 15.7c-2.3 1.7-3 2-3 2m.4-17s.3 13-1 25m-4.7.7s6.8-1 9.1-1M46 270l-.9 4.6m1.8-11.3-.8 4.1m16.6-64.9c-.3 1.6 0 2-.4 3.4 0 0-2.8 2-2.3 4s-.3 3.4-4.5 17.2c-1.8 5.8-4.3 19-6.2 28.3l-1.1 5.8m16-67-1 4.9m8.1-52.3-1.2 10.9s-1.2.1-.5 2.3c0 1.4-2.8 16.4-5.4 31.6m-20 82.1h13.9"
      />
      <path
        fill="#192064"
      ...
      />
      <path stroke="#E59788" d="M79.5 108.7c-2 2.9-4.2 6.1-5.5 8.7" />
      <path
        fill="#FFC6A0"
      ...
      />
      <path stroke="#E4EBF7" d="M109.3 112.5s3.4-3.6 7.6-4.6" />
      <path stroke="#E59788" d="M107.4 123s9.7-2.7 11.4-.9" />
      <path
        stroke="#BFCDDD"
      ...
      />
      <path fill="#A3B4C6" d="M154.1 190.1h70.5v-84.6h-70.5z" mask="url(#d)" />
      <path
        fill="#BFCDDD"
      ...
      <path
        ...
        mask="url(#d)"
      />
      <path stroke="#A3B4C6" d="M177.3 207.2v11.5m23.8-11.5v11.5" mask="url(#d)" />
      <path
        fill="#5BA02E"
