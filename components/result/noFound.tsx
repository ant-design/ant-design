...
const NoFound: React.FC = () => (
  <svg width="252" height="294">
    ...
    <g fill="none">
      <path
        fill="#E4EBF7"
        d="M0 127.3v-2A125 125 0 0 1 124.8.2h2.1c69 0 124.9 56 124.9 125v2c0 69-56 124.9-124.9 124.9h-2A125 125 0 0 1 0 127.2"
        mask="url(#b)"
      />
      <path
        fill="#FFF"
        d="M39.8 130.8a8.3 8.3 0 1 1-16.5-1.6 8.3 8.3 0 0 1 16.5 1.6m.1 28.6a5.7 5.7 0 1 1-11.3-1.2 5.7 5.7 0 0 1 11.3 1.2m17.7-16.2a5.7 5.7 0 1 1-11.4-1.1 5.7 5.7 0 0 1 11.4 1.1M99 27h29.8a4.6 4.6 0 1 0 0-9.2H99a4.6 4.6 0 1 0 0 9.2m11.4 18.3h29.8a4.6 4.6 0 0 0 0-9.2h-29.8a4.6 4.6 0 1 0 0 9.2"
      />
      <path
        fill="#FFF"
        d="M112.8 26.9h15.8a4.6 4.6 0 1 0 0 9.1h-15.8a4.6 4.6 0 0 0 0-9.1m71.7 108.8a10 10 0 1 1-19.8-2 10 10 0 0 1 19.8 2m.2 34.3a6.8 6.8 0 1 1-13.6-1.3 6.8 6.8 0 0 1 13.6 1.4m18.6-16.8a6.9 6.9 0 1 1-13.7-1.4 6.9 6.9 0 0 1 13.7 1.4"
      />
      <path
        stroke="#FFF"
      ...
      />
      <path fill="#1677ff" d="M174.8 30a29.5 29.5 0 1 1 59 0 29.5 29.5 0 0 1-59 0" />
      <path
        fill="#FFF"
      ...
      />
      <path stroke="#DB836E" d="m110.1 74.8-.9 1.7-.3 4.3h-2.2" />
      <path stroke="#5C2552" d="M110.8 74.5s1.8-.7 2.6.5" />
      <path stroke="#DB836E" d="M92.4 74.3s.5-1.1 1.1-.7c.6.4 1.3 1.4.6 2-.8.5.1 1.6.1 1.6" />
      <path stroke="#5C2552" d="M103.3 73s1.8 1 4.1.9" />
      <path
        stroke="#DB836E"
      ...
      />
      <path stroke="#E4EBF7" d="M89 89.5s7.8 5.4 16.6 2.8" />
    </g>
  </svg>
);
