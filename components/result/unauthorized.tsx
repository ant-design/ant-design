...
const Unauthorized: React.FC = () => (
  <svg width="251" height="294">
    ...
    <g fill="none">
      ...
      <path
        fill="#FFF"
        d="M41.4 133a8.2 8.2 0 1 1-16.4-1.7 8.2 8.2 0 0 1 16.4 1.6m.1 28.4a5.6 5.6 0 1 1-11.2-1.2 5.6 5.6 0 0 1 11.2 1.2m17.7-16a5.7 5.7 0 1 1-11.3-1.2 5.7 5.7 0 0 1 11.3 1.2m41.2-115.8H130a4.6 4.6 0 1 0 0-9.1h-29.6a4.6 4.6 0 0 0 0 9.1m11.3 18.3h29.7a4.6 4.6 0 1 0 0-9.2h-29.7a4.6 4.6 0 1 0 0 9.2"
      />
      <path
        fill="#FFF"
        d="M114 29.5h15.8a4.6 4.6 0 1 0 0 9.1H114a4.6 4.6 0 0 0 0-9.1m71.3 108.2a10 10 0 1 1-19.8-2 10 10 0 0 1 19.8 2m.3 34.3a6.8 6.8 0 1 1-13.6-1.4 6.8 6.8 0 0 1 13.5 1.3m18.6-16.6a6.8 6.8 0 1 1-13.6-1.4 6.8 6.8 0 0 1 13.6 1.4"
      />
      <path
        stroke="#FFF"
      ...
      <path
        stroke="#E4EBF7"
        d="M78.2 94.7s.9 7.4-5 13m14.2-13s3.1 2.6 10.3 2.6c7.1 0 9-3.5 9-3.5"
      />
      <path
        fill="#FFC6A0"
      ...
      />
      <path stroke="#DB836E" d="m100.8 77.1 1.7-1-1-4.3.7-1.4" />
      <path
        fill="#552950"
      ...
      />
      <path stroke="#DB836E" d="M91.1 86.8s5.3 5 12.7 2.3" />
      <path fill="#DB836E" d="M99.8 81.9s-3.6.2-1.5-2.8c1.6-1.5 5-.4 5-.4s1 3.9-3.5 3.2" />
      <path stroke="#5C2552" d="M102.9 70.6s2.5.8 3.4.7m-12.4.7s2.5-1.2 4.8-1.1" />
      <path stroke="#DB836E" d="M86.3 77.4s1 .9 1.5 2c-.4.6-1 1.2-.3 1.9m11.8 2.4s2 .2 2.5-.2" />
      <path
        stroke="#E4EBF7"
        d="m87.8 115.8 15.7-3m-3.3 3 10-2m-43.7-27s-1.6 8.8-6.7 14M128.3 88s3 4 4 11.7"
      />
      <path stroke="#DB836E" d="M64 84.8s-6 10-13.5 10" />
      <path
        fill="#FFC6A0"
      ...
      />
      <path stroke="#DB836E" d="M130.5 85.5s4.6 5.7 11.7 6.2" />
      <path stroke="#E4EBF7" d="M121.7 105.7s-.4 8.6-1.3 13.6" />
      <path stroke="#648BD8" d="M115.8 161.5s-3.6-1.5-2.7-7.1" />
      <path
        fill="#CBD1D1"
      ...
      <path
        stroke="#648BD8"
        d="M77.4 220.4c1.2.1 4-2 7-4.9m23.1 8.4s2.8-1 6.1-3.8m-5.1.9s2.7-1.2 6-4m-38.4 6.6s2.6-.6 6.5-3.4m4.7-69.4c-.2 3.1.3 8.5-4.3 9m21.8-10.7s.1 14-1.3 15c-2.2 1.6-3 1.9-3 1.9m.5-16.4s0 12.8-1.2 24.3m-4.9 1s7.2-1.6 9.4-1.6m-28.6 31.5-1 4.5s-1.5 1.8-1 3.7c.4 2-1 2-5 15.3-1.7 5.6-4.4 18.5-6.3 27.5l-4 18.4M77 196.7a313.3 313.3 0 0 1-.8 4.8m7.7-50-1.2 10.3s-1 .2-.5 2.3c.1 1.3-2.6 15.6-5.1 30.2M57.6 273h13.2"
      />
