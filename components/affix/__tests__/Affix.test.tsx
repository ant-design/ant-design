...
class AffixMounter extends React.Component<{
  ...
  onChange?: () => void;
  getInstance?: (inst: React.Component<AffixProps, AffixState>) => void;
}> {
...
describe('Affix Render', () => {
  ...
  describe('updatePosition when size changed', () => {
    it.each([
      ...
      let affixInstance: React.Component<AffixProps, AffixState> | null = null;
      const updateCalled = jest.fn();
      const affixMounterWrapper = render(
        <AffixMounter
          getInstance={inst => {
            affixInstance = inst;
          }}
      ...
      triggerResize(affixMounterWrapper.container);
      await sleep(20);
